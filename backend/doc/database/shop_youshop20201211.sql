...
--
-- 转存表中的数据 `yoshop_admin_user`
--

INSERT INTO `yoshop_admin_user` (`admin_user_id`, `user_name`, `password`, `create_time`, `update_time`) VALUES
(10001, 'admin', '9ae7b2e6f25c907a1fc81b503b16e25f', 1529926348, 1540194026);
...
--
-- 转存表中的数据 `yoshop_category`
--

INSERT INTO `yoshop_category` (`category_id`, `name`, `parent_id`, `image_id`, `sort`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '轮胎', 0, 10001, 100, 10001, 1606439579, 1606439579);
...
CREATE TABLE `yoshop_comment` (
  ...
  `create_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='订单评价记录表';

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_comment_image`
--
...
--
-- 转存表中的数据 `yoshop_coupon`
--

INSERT INTO `yoshop_coupon` (`coupon_id`, `name`, `color`, `coupon_type`, `reduce_price`, `discount`, `min_price`, `expire_type`, `expire_day`, `start_time`, `end_time`, `apply_range`, `total_num`, `receive_num`, `sort`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '满100减10', 10, 10, '100.00', 0, '200.00', 10, 3, 0, 0, 10, -1, 0, 100, 0, 10001, 1606445714, 1606445714);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_coupon_goods`
--
...
--
-- 表的结构 `yoshop_dealer_apply`
--

CREATE TABLE `yoshop_dealer_apply` (
  `apply_id` int(11) UNSIGNED NOT NULL COMMENT '主键id',
  `user_id` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '用户id',
  ...
  `create_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='分销商申请记录表';

--
-- 转存表中的数据 `yoshop_dealer_apply`
--

INSERT INTO `yoshop_dealer_apply` (`apply_id`, `user_id`, `real_name`, `mobile`, `referee_id`, `apply_type`, `apply_time`, `apply_status`, `audit_time`, `reject_reason`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 10001, 'test', '18250766666', 0, 10, 1606448953, 20, 1606448968, '', 10001, 1606448953, 1606448968);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_dealer_capital`
--
...
CREATE TABLE `yoshop_dealer_capital` (
  ...
  `create_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='分销商资金明细表';

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_dealer_order`
--
...
CREATE TABLE `yoshop_dealer_order` (
  ...
  `create_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='分销商订单记录表';

--
-- 转存表中的数据 `yoshop_dealer_order`
--

INSERT INTO `yoshop_dealer_order` (`id`, `user_id`, `order_id`, `order_type`, `order_no`, `order_price`, `first_user_id`, `second_user_id`, `third_user_id`, `first_money`, `second_money`, `third_money`, `is_invalid`, `is_settled`, `settle_time`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 10001, 10001, 10, '', '2.00', 10001, 0, 0, '0.20', '0.00', '0.00', 0, 0, 0, 10001, 1606465770, 1606465770);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_dealer_referee`
--
...
CREATE TABLE `yoshop_dealer_referee` (
  ...
  `wxapp_id` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='分销商推荐关系表';

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_dealer_setting`
--
...
--
-- 转存表中的数据 `yoshop_dealer_setting`
--

INSERT INTO `yoshop_dealer_setting` (`key`, `describe`, `values`, `wxapp_id`, `update_time`) VALUES
('background', '页面背景图', '{\"__\":\"\",\"index\":\"http:\\/\\/youshop.local.com\\/assets\\/api\\/dealer-bg.png\",\"apply\":\"http:\\/\\/youshop.local.com\\/assets\\/api\\/dealer-bg.png\",\"withdraw_apply\":\"http:\\/\\/youshop.local.com\\/assets\\/api\\/dealer-bg.png\"}', 10001, 1606448870),
('basic', '基础设置', '{\"is_open\":\"1\",\"level\":\"1\",\"self_buy\":\"1\"}', 10001, 1606448870),
('commission', '佣金设置', '{\"first_money\":\"0\",\"second_money\":\"0\",\"third_money\":\"0\"}', 10001, 1606448870),
('condition', '分销商条件', '{\"become\":\"10\",\"become__buy_goods\":\"0\",\"downline\":\"10\"}', 10001, 1606448870),
('license', '申请协议', '{\"license\":\"\"}', 10001, 1606448870),
('qrcode', '分销海报', '{\"backdrop\":{\"src\":\"http:\\/\\/youshop.local.com\\/uploads\\/20201127143539e00bf9793.png\"},\"nickName\":{\"fontSize\":\"14\",\"color\":\"#000000\",\"left\":\"150\",\"top\":\"99\"},\"avatar\":{\"width\":\"70\",\"style\":\"circle\",\"left\":\"150\",\"top\":\"18\"},\"qrcode\":{\"width\":\"100\",\"style\":\"circle\",\"left\":\"136\",\"top\":\"128\"}}', 10001, 1606458945),
('settlement', '结算', '{\"pay_type\":[\"20\"],\"min_money\":\"10.00\",\"settle_days\":\"10\"}', 10001, 1606448870),
('template_msg', '模板消息', '{\"apply_tpl\":\"\",\"withdraw_tpl\":\"\"}', 10001, 1606448870),
('words', '自定义文字', '{\"index\":{\"title\":{\"value\":\"\\u5206\\u9500\\u4e2d\\u5fc3\"},\"words\":{\"not_dealer\":{\"value\":\"\\u60a8\\u8fd8\\u4e0d\\u662f\\u5206\\u9500\\u5546\\uff0c\\u8bf7\\u5148\\u63d0\\u4ea4\\u7533\\u8bf7\"},\"apply_now\":{\"value\":\"\\u7acb\\u5373\\u52a0\\u5165\"},\"referee\":{\"value\":\"\\u63a8\\u8350\\u4eba\"},\"money\":{\"value\":\"\\u53ef\\u63d0\\u73b0\"},\"freeze_money\":{\"value\":\"\\u5f85\\u63d0\\u73b0\"},\"total_money\":{\"value\":\"\\u5df2\\u63d0\\u73b0\\u91d1\\u989d\"},\"withdraw\":{\"value\":\"\\u53bb\\u63d0\\u73b0\"}}},\"apply\":{\"title\":{\"value\":\"\\u7533\\u8bf7\\u6210\\u4e3a\\u5206\\u9500\\u5546\"},\"words\":{\"title\":{\"value\":\"\\u8bf7\\u586b\\u5199\\u7533\\u8bf7\\u4fe1\\u606f\"},\"license\":{\"value\":\"\\u5206\\u9500\\u5546\\u7533\\u8bf7\\u534f\\u8bae\"},\"submit\":{\"value\":\"\\u7533\\u8bf7\\u6210\\u4e3a\\u7ecf\\u9500\\u5546\"},\"wait_audit\":{\"value\":\"\\u60a8\\u7684\\u7533\\u8bf7\\u5df2\\u53d7\\u7406\\uff0c\\u6b63\\u5728\\u8fdb\\u884c\\u4fe1\\u606f\\u6838\\u9a8c\\uff0c\\u8bf7\\u8010\\u5fc3\\u7b49\\u5f85\\u3002\"},\"goto_mall\":{\"value\":\"\\u53bb\\u5546\\u57ce\\u901b\\u901b\"}}},\"order\":{\"title\":{\"value\":\"\\u5206\\u9500\\u8ba2\\u5355\"},\"words\":{\"all\":{\"value\":\"\\u5168\\u90e8\"},\"unsettled\":{\"value\":\"\\u672a\\u7ed3\\u7b97\"},\"settled\":{\"value\":\"\\u5df2\\u7ed3\\u7b97\"}}},\"team\":{\"title\":{\"value\":\"\\u6211\\u7684\\u56e2\\u961f\"},\"words\":{\"total_team\":{\"value\":\"\\u56e2\\u961f\\u603b\\u4eba\\u6570\"},\"first\":{\"value\":\"\\u4e00\\u7ea7\\u56e2\\u961f\"},\"second\":{\"value\":\"\\u4e8c\\u7ea7\\u56e2\\u961f\"},\"third\":{\"value\":\"\\u4e09\\u7ea7\\u56e2\\u961f\"}}},\"withdraw_list\":{\"title\":{\"value\":\"\\u63d0\\u73b0\\u660e\\u7ec6\"},\"words\":{\"all\":{\"value\":\"\\u5168\\u90e8\"},\"apply_10\":{\"value\":\"\\u5ba1\\u6838\\u4e2d\"},\"apply_20\":{\"value\":\"\\u5ba1\\u6838\\u901a\\u8fc7\"},\"apply_40\":{\"value\":\"\\u5df2\\u6253\\u6b3e\"},\"apply_30\":{\"value\":\"\\u9a73\\u56de\"}}},\"withdraw_apply\":{\"title\":{\"value\":\"\\u7533\\u8bf7\\u63d0\\u73b0\"},\"words\":{\"capital\":{\"value\":\"\\u53ef\\u63d0\\u73b0\\u4f63\\u91d1\"},\"money\":{\"value\":\"\\u63d0\\u73b0\\u91d1\\u989d\"},\"money_placeholder\":{\"value\":\"\\u8bf7\\u8f93\\u5165\\u8981\\u63d0\\u53d6\\u7684\\u91d1\\u989d\"},\"min_money\":{\"value\":\"\\u6700\\u4f4e\\u63d0\\u73b0\\u4f63\\u91d1\"},\"submit\":{\"value\":\"\\u63d0\\u4ea4\\u7533\\u8bf7\"}}},\"qrcode\":{\"title\":{\"value\":\"\\u63a8\\u5e7f\\u4e8c\\u7ef4\\u7801\"}}}', 10001, 1606448870);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_dealer_user`
--
...
--
-- 转存表中的数据 `yoshop_dealer_user`
--

INSERT INTO `yoshop_dealer_user` (`user_id`, `real_name`, `mobile`, `money`, `freeze_money`, `total_money`, `referee_id`, `first_num`, `second_num`, `third_num`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 'test', '18250766666', '0.00', '0.00', '0.00', 0, 0, 0, 0, 0, 10001, 1606448968, 1606448968);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_dealer_withdraw`
--
...
CREATE TABLE `yoshop_dealer_withdraw` (
  ...
  `create_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='分销商提现明细表';

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_delivery`
--

CREATE TABLE `yoshop_delivery` (
  `delivery_id` int(11) UNSIGNED NOT NULL COMMENT '模板id',
  ...
  `create_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='配送模板主表';

--
-- 转存表中的数据 `yoshop_delivery`
--

INSERT INTO `yoshop_delivery` (`delivery_id`, `name`, `method`, `wxapp_id`, `sort`, `create_time`, `update_time`) VALUES
(10001, '全国包邮', 10, 10001, 100, 1535083514, 1535083514);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_delivery_rule`
--
...
CREATE TABLE `yoshop_express` (
  `express_id` int(11) UNSIGNED NOT NULL COMMENT '物流公司id',
  ...
  `create_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='物流公司记录表';

--
-- 转存表中的数据 `yoshop_express`
--

INSERT INTO `yoshop_express` (`express_id`, `express_name`, `express_code`, `sort`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '顺丰速运', 'shunfeng', 100, 10001, 1535160797, 1535160797),
(10002, '邮政国内', 'yzguonei', 100, 10001, 1535942653, 1535942653),
(10003, '圆通速递', 'yuantong', 100, 10001, 1535942675, 1535942675),
(10004, '申通快递', 'shentong', 100, 10001, 1535942694, 1535942694),
(10005, '韵达快递', 'yunda', 100, 10001, 1535942711, 1535942711),
(10006, '百世快递', 'huitongkuaidi', 100, 10001, 1535942743, 1535942743),
(10007, '中通快递', 'zhongtong', 100, 10001, 1535942764, 1535942764),
(10008, '天天快递', 'tiantian', 100, 10001, 1535942783, 1535942783),
(10009, '宅急送', 'zhaijisong', 100, 10001, 1535942798, 1535942798);
...
--
-- 转存表中的数据 `yoshop_goods`
--

INSERT INTO `yoshop_goods` (`goods_id`, `goods_name`, `selling_point`, `category_id`, `spec_type`, `deduct_stock_type`, `content`, `sales_initial`, `sales_actual`, `goods_sort`, `delivery_id`, `is_enable_grade`, `is_alone_grade`, `alone_grade_equity`, `is_ind_dealer`, `dealer_money_type`, `first_money`, `second_money`, `third_money`, `goods_status`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '米其林', 'test', 10001, 20, 10, '&lt;p&gt;test&lt;/p&gt;', 0, 0, 100, 10001, 1, 0, NULL, 1, 10, '10.00', '5.00', '2.00', 10, 0, 10001, 1606439690, 1606445286);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_goods_image`
--
...
--
-- 转存表中的数据 `yoshop_goods_image`
--

INSERT INTO `yoshop_goods_image` (`id`, `goods_id`, `image_id`, `wxapp_id`, `create_time`) VALUES
(10003, 10001, 10001, 10001, 1606445286);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_goods_sku`
--
...
--
-- 转存表中的数据 `yoshop_goods_sku`
--

INSERT INTO `yoshop_goods_sku` (`goods_sku_id`, `goods_id`, `spec_sku_id`, `image_id`, `goods_no`, `goods_price`, `line_price`, `stock_num`, `goods_sales`, `goods_weight`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10013, 10001, '10001_10004', 0, '', '2.00', '3.00', 3, 0, 1, 10001, 1606445286, 1606465769),
(10014, 10001, '10001_10005', 0, '', '2.00', '3.00', 4, 0, 1, 10001, 1606445286, 1606445286),
(10015, 10001, '10002_10004', 0, '', '2.00', '3.00', 4, 0, 1, 10001, 1606445286, 1606445286),
(10016, 10001, '10002_10005', 0, '', '2.00', '3.00', 4, 0, 1, 10001, 1606445286, 1606445286),
(10017, 10001, '10003_10004', 0, '', '2.00', '3.00', 4, 0, 1, 10001, 1606445286, 1606445286),
(10018, 10001, '10003_10005', 0, '', '2.00', '3.00', 4, 0, 1, 10001, 1606445286, 1606445286);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_goods_spec_rel`
--
...
--
-- 转存表中的数据 `yoshop_goods_spec_rel`
--

INSERT INTO `yoshop_goods_spec_rel` (`id`, `goods_id`, `spec_id`, `spec_value_id`, `wxapp_id`, `create_time`) VALUES
(10011, 10001, 10001, 10001, 10001, 1606445286),
(10012, 10001, 10001, 10002, 10001, 1606445286),
(10013, 10001, 10001, 10003, 10001, 1606445286),
(10014, 10001, 10002, 10004, 10001, 1606445286),
(10015, 10001, 10002, 10005, 10001, 1606445286);
...
CREATE TABLE `yoshop_order` (
  ...
  `user_id` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '用户id',
  `is_user_expend` tinyint(3) UNSIGNED NOT NULL DEFAULT '0' COMMENT '标识：累积用户实际消费金额',
  `is_delete` tinyint(3) UNSIGNED NOT NULL DEFAULT '0' COMMENT '是否删除',
  `wxapp_id` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '更新时间'
...
--
-- 转存表中的数据 `yoshop_order`
--

INSERT INTO `yoshop_order` (`order_id`, `order_no`, `total_price`, `order_price`, `coupon_id`, `coupon_money`, `pay_price`, `update_price`, `buyer_remark`, `pay_type`, `pay_status`, `pay_time`, `delivery_type`, `extract_shop_id`, `extract_clerk_id`, `express_price`, `express_id`, `express_company`, `express_no`, `delivery_status`, `delivery_time`, `receipt_status`, `receipt_time`, `order_status`, `transaction_id`, `is_comment`, `user_id`, `is_user_expend`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '2020112757571029', '2.00', '2.00', 0, '0.00', '2.00', '0.00', '', 20, 10, 0, 10, 0, 0, '0.00', 0, '', '', 10, 0, 10, 0, 10, '', 0, 10001, 0, 0, 10001, 1606465769, 1606465769);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_order_address`
--

CREATE TABLE `yoshop_order_address` (
  `order_address_id` int(11) UNSIGNED NOT NULL COMMENT '地址id',
...
--
-- 转存表中的数据 `yoshop_order_address`
--

INSERT INTO `yoshop_order_address` (`order_address_id`, `name`, `phone`, `province_id`, `city_id`, `region_id`, `detail`, `order_id`, `user_id`, `wxapp_id`, `create_time`) VALUES
(10001, '张三', '020-81167888', 1964, 1965, 1968, '新港中路397号', 10001, 10001, 10001, 1606465769);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_order_extract`
--
...
--
-- 表的结构 `yoshop_order_goods`
--

CREATE TABLE `yoshop_order_goods` (
  `order_goods_id` int(11) UNSIGNED NOT NULL COMMENT '主键id',
  `goods_id` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '商品id',
  `goods_name` varchar(255) NOT NULL DEFAULT '' COMMENT '商品名称',
...
--
-- 转存表中的数据 `yoshop_order_goods`
--

INSERT INTO `yoshop_order_goods` (`order_goods_id`, `goods_id`, `goods_name`, `image_id`, `deduct_stock_type`, `spec_type`, `spec_sku_id`, `goods_sku_id`, `goods_attr`, `content`, `goods_no`, `goods_price`, `line_price`, `goods_weight`, `is_user_grade`, `grade_ratio`, `grade_goods_price`, `grade_total_money`, `coupon_money`, `total_num`, `total_price`, `total_pay_price`, `is_ind_dealer`, `dealer_money_type`, `first_money`, `second_money`, `third_money`, `is_comment`, `order_id`, `user_id`, `wxapp_id`, `create_time`) VALUES
(10001, 10001, '米其林', 10001, 10, 20, '10001_10004', 10013, 'test:123; 纹路:X; ', '<p>test</p>', '', '2.00', '3.00', 1, 0, 0, '0.00', '0.00', '0.00', 1, '2.00', '2.00', 1, 10, '10.00', '5.00', '2.00', 0, 10001, 10001, 10001, 1606465769);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_order_refund`
--

CREATE TABLE `yoshop_order_refund` (
  `order_refund_id` int(11) UNSIGNED NOT NULL COMMENT '售后单id',
  `order_id` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '订单id',
  `order_goods_id` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '订单商品id',
  `user_id` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '用户id',
...
--
-- 表的结构 `yoshop_order_refund_address`
--
...
--
-- 表的结构 `yoshop_order_refund_image`
--
...
CREATE TABLE `yoshop_printer` (
  `printer_id` int(11) UNSIGNED NOT NULL COMMENT '打印机id',
...
--
-- 表的结构 `yoshop_recharge_order_plan`
--

CREATE TABLE `yoshop_recharge_order_plan` (
  `order_plan_id` int(11) UNSIGNED NOT NULL COMMENT '主键id',
  `order_id` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '订单id',
...
--
-- 转存表中的数据 `yoshop_region`
--

INSERT INTO `yoshop_region` (`id`, `pid`, `shortname`, `name`, `merger_name`, `level`, `pinyin`, `code`, `zip_code`, `first`, `lng`, `lat`) VALUES
...
(19, 0, '天津', '天津市', '中国,天津', 1, 'tianjin', '', '', 'T', '117.190182', '39.125596'),
...
(801, 0, '上海', '上海市', '中国,上海', 1, 'shanghai', '', '', 'S', '121.472644', '31.231706'),
...
(2323, 0, '重庆', '重庆市', '中国,重庆', 1, 'chongqing', '', '', 'Z', '106.504962', '29.533155'),
...
(3325, 0, '台湾', '台湾省', '中国,台湾省', 1, 'taiwan', '', '', 'T', '121.509062', '25.044332'),
(3326, 3325, '台北', '台北市', '中国,台湾省,台北市', 2, 'taipei', '02', '1', 'T', '121.565170', '25.037798'),
(3327, 3326, '松山', '松山区', '中国,台湾省,台北市,松山区', 3, 'songshan', '02', '105', 'S', '121.577206', '25.049698'),
(3328, 3326, '信义', '信义区', '中国,台湾省,台北市,信义区', 3, 'xinyi', '02', '110', 'X', '121.751381', '25.129407'),
(3329, 3326, '大安', '大安区', '中国,台湾省,台北市,大安区', 3, 'da\'an', '02', '106', 'D', '121.534648', '25.026406'),
(3330, 3326, '中山', '中山区', '中国,台湾省,台北市,中山区', 3, 'zhongshan', '02', '104', 'Z', '121.533468', '25.064361'),
(3331, 3326, '中正', '中正区', '中国,台湾省,台北市,中正区', 3, 'zhongzheng', '02', '100', 'Z', '121.518267', '25.032361'),
(3332, 3326, '大同', '大同区', '中国,台湾省,台北市,大同区', 3, 'datong', '02', '103', 'D', '121.515514', '25.065986'),
(3333, 3326, '万华', '万华区', '中国,台湾省,台北市,万华区', 3, 'wanhua', '02', '108', 'W', '121.499332', '25.031933'),
(3334, 3326, '文山', '文山区', '中国,台湾省,台北市,文山区', 3, 'wenshan', '02', '116', 'W', '121.570458', '24.989786'),
(3335, 3326, '南港', '南港区', '中国,台湾省,台北市,南港区', 3, 'nangang', '02', '115', 'N', '121.606858', '25.054656'),
(3336, 3326, '内湖', '内湖区', '中国,台湾省,台北市,内湖区', 3, 'nahu', '02', '114', 'N', '121.588998', '25.069664'),
(3337, 3326, '士林', '士林区', '中国,台湾省,台北市,士林区', 3, 'shilin', '02', '111', 'S', '121.519874', '25.092822'),
(3338, 3326, '北投', '北投区', '中国,台湾省,台北市,北投区', 3, 'beitou', '02', '112', 'B', '121.501379', '25.132419'),
(3339, 3325, '高雄', '高雄市', '中国,台湾省,高雄市', 2, 'kaohsiung', '07', '8', 'G', '120.311922', '22.620856'),
(3340, 3339, '盐埕', '盐埕区', '中国,台湾省,高雄市,盐埕区', 3, 'yancheng', '07', '803', 'Y', '120.286795', '22.624666'),
(3341, 3339, '鼓山', '鼓山区', '中国,台湾省,高雄市,鼓山区', 3, 'gushan', '07', '804', 'G', '120.281154', '22.636797'),
(3342, 3339, '左营', '左营区', '中国,台湾省,高雄市,左营区', 3, 'zuoying', '07', '813', 'Z', '120.294958', '22.690124'),
(3343, 3339, '楠梓', '楠梓区', '中国,台湾省,高雄市,楠梓区', 3, 'nanzi', '07', '811', NULL, '120.326314', '22.728401'),
(3344, 3339, '三民', '三民区', '中国,台湾省,高雄市,三民区', 3, 'sanmin', '07', '807', 'S', '120.299622', '22.647695'),
(3345, 3339, '新兴', '新兴区', '中国,台湾省,高雄市,新兴区', 3, 'xinxing', '07', '800', 'X', '120.309535', '22.631147'),
(3346, 3339, '前金', '前金区', '中国,台湾省,高雄市,前金区', 3, 'qianjin', '07', '801', 'Q', '120.294159', '22.627421'),
(3347, 3339, '苓雅', '苓雅区', '中国,台湾省,高雄市,苓雅区', 3, 'lingya', '07', '802', NULL, '120.312347', '22.621770'),
(3348, 3339, '前镇', '前镇区', '中国,台湾省,高雄市,前镇区', 3, 'qianzhen', '07', '806', 'Q', '120.318583', '22.586425'),
(3349, 3339, '旗津', '旗津区', '中国,台湾省,高雄市,旗津区', 3, 'qijin', '07', '805', 'Q', '120.284429', '22.590565'),
(3350, 3339, '小港', '小港区', '中国,台湾省,高雄市,小港区', 3, 'xiaogang', '07', '812', 'X', '120.337970', '22.565354'),
(3351, 3339, '凤山', '凤山区', '中国,台湾省,高雄市,凤山区', 3, 'fengshan', '07', '830', 'F', '120.356892', '22.626945'),
(3352, 3339, '林园', '林园区', '中国,台湾省,高雄市,林园区', 3, 'linyuan', '07', '832', 'L', '120.395977', '22.501490'),
(3353, 3339, '大寮', '大寮区', '中国,台湾省,高雄市,大寮区', 3, 'daliao', '07', '831', 'D', '120.395422', '22.605386'),
(3354, 3339, '大树', '大树区', '中国,台湾省,高雄市,大树区', 3, 'dashu', '07', '840', 'D', '120.433095', '22.693394'),
(3355, 3339, '大社', '大社区', '中国,台湾省,高雄市,大社区', 3, 'dashe', '07', '815', 'D', '120.346635', '22.729966'),
(3356, 3339, '仁武', '仁武区', '中国,台湾省,高雄市,仁武区', 3, 'renwu', '07', '814', 'R', '120.347779', '22.701901'),
(3357, 3339, '鸟松', '鸟松区', '中国,台湾省,高雄市,鸟松区', 3, 'niaosong', '07', '833', 'N', '120.364402', '22.659340'),
(3358, 3339, '冈山', '冈山区', '中国,台湾省,高雄市,冈山区', 3, 'gangshan', '07', '820', 'G', '120.295820', '22.796762'),
(3359, 3339, '桥头', '桥头区', '中国,台湾省,高雄市,桥头区', 3, 'qiaotou', '07', '825', 'Q', '120.305741', '22.757501'),
(3360, 3339, '燕巢', '燕巢区', '中国,台湾省,高雄市,燕巢区', 3, 'yanchao', '07', '824', 'Y', '120.361956', '22.793370'),
(3361, 3339, '田寮', '田寮区', '中国,台湾省,高雄市,田寮区', 3, 'tianliao', '07', '823', 'T', '120.359636', '22.869307'),
(3362, 3339, '阿莲', '阿莲区', '中国,台湾省,高雄市,阿莲区', 3, 'alian', '07', '822', 'A', '120.327036', '22.883703'),
(3363, 3339, '路竹', '路竹区', '中国,台湾省,高雄市,路竹区', 3, 'luzhu', '07', '821', 'L', '120.261828', '22.856851'),
(3364, 3339, '湖内', '湖内区', '中国,台湾省,高雄市,湖内区', 3, 'huna', '07', '829', 'H', '120.211530', '22.908188'),
(3365, 3339, '茄萣', '茄萣区', '中国,台湾省,高雄市,茄萣区', 3, 'qieding', '07', '852', NULL, '120.182815', '22.906556'),
(3366, 3339, '永安', '永安区', '中国,台湾省,高雄市,永安区', 3, 'yong\'an', '07', '828', 'Y', '120.225308', '22.818580'),
(3367, 3339, '弥陀', '弥陀区', '中国,台湾省,高雄市,弥陀区', 3, 'mituo', '07', '827', 'M', '120.247344', '22.782879'),
(3368, 3339, '梓官', '梓官区', '中国,台湾省,高雄市,梓官区', 3, 'ziguan', '07', '826', NULL, '120.267322', '22.760475'),
(3369, 3339, '旗山', '旗山区', '中国,台湾省,高雄市,旗山区', 3, 'qishan', '07', '842', 'Q', '120.483550', '22.888491'),
(3370, 3339, '美浓', '美浓区', '中国,台湾省,高雄市,美浓区', 3, 'meinong', '07', '843', 'M', '120.541530', '22.897880'),
(3371, 3339, '六龟', '六龟区', '中国,台湾省,高雄市,六龟区', 3, 'liugui', '07', '844', 'L', '120.633418', '22.997914'),
(3372, 3339, '甲仙', '甲仙区', '中国,台湾省,高雄市,甲仙区', 3, 'jiaxian', '07', '847', 'J', '120.591185', '23.084688'),
(3373, 3339, '杉林', '杉林区', '中国,台湾省,高雄市,杉林区', 3, 'shanlin', '07', '846', 'S', '120.538980', '22.970712'),
(3374, 3339, '内门', '内门区', '中国,台湾省,高雄市,内门区', 3, 'namen', '07', '845', 'N', '120.462351', '22.943437'),
(3375, 3339, '茂林', '茂林区', '中国,台湾省,高雄市,茂林区', 3, 'maolin', '07', '851', 'M', '120.663217', '22.886248'),
(3376, 3339, '桃源', '桃源区', '中国,台湾省,高雄市,桃源区', 3, 'taoyuan', '07', '848', 'T', '120.760049', '23.159137'),
(3377, 3339, '那玛夏', '那玛夏区', '中国,台湾省,高雄市,那玛夏区', 3, 'namaxia', '07', '849', 'N', '120.692799', '23.216964'),
(3378, 3325, '基隆', '基隆市', '中国,台湾省,基隆市', 2, 'keelung', '02', '2', 'J', '121.746248', '25.130741'),
(3379, 3378, '中正', '中正区', '中国,台湾省,基隆市,中正区', 3, 'zhongzheng', '02', '202', 'Z', '121.518267', '25.032361'),
(3380, 3378, '七堵', '七堵区', '中国,台湾省,基隆市,七堵区', 3, 'qidu', '02', '206', 'Q', '121.713032', '25.095739'),
(3381, 3378, '暖暖', '暖暖区', '中国,台湾省,基隆市,暖暖区', 3, 'nuannuan', '02', '205', 'N', '121.736102', '25.099777'),
(3382, 3378, '仁爱', '仁爱区', '中国,台湾省,基隆市,仁爱区', 3, 'renai', '02', '200', 'R', '121.740940', '25.127526'),
(3383, 3378, '中山', '中山区', '中国,台湾省,基隆市,中山区', 3, 'zhongshan', '02', '203', 'Z', '121.739132', '25.133991'),
(3384, 3378, '安乐', '安乐区', '中国,台湾省,基隆市,安乐区', 3, 'anle', '02', '204', 'A', '121.723203', '25.120910'),
(3385, 3378, '信义', '信义区', '中国,台湾省,基隆市,信义区', 3, 'xinyi', '02', '201', 'X', '121.751381', '25.129407'),
(3386, 3325, '台中', '台中市', '中国,台湾省,台中市', 2, 'taichung', '04', '4', 'T', '120.679040', '24.138620'),
(3387, 3386, '中区', '中区', '中国,台湾省,台中市,中区', 3, 'zhongqu', '04', '400', 'Z', '120.679510', '24.143830'),
(3388, 3386, '东区', '东区', '中国,台湾省,台中市,东区', 3, 'dongqu', '04', '401', 'D', '120.704', '24.13662'),
(3389, 3386, '南区', '南区', '中国,台湾省,台中市,南区', 3, 'nanqu', '04', '402', 'N', '120.188648', '22.960944'),
(3390, 3386, '西区', '西区', '中国,台湾省,台中市,西区', 3, 'xiqu', '04', '403', 'X', '120.67104', '24.14138'),
(3391, 3386, '北区', '北区', '中国,台湾省,台中市,北区', 3, 'beiqu', '04', '404', 'B', '120.682410', '24.166040'),
(3392, 3386, '西屯', '西屯区', '中国,台湾省,台中市,西屯区', 3, 'xitun', '04', '407', 'X', '120.639820', '24.181340'),
(3393, 3386, '南屯', '南屯区', '中国,台湾省,台中市,南屯区', 3, 'nantun', '04', '408', 'N', '120.643080', '24.138270'),
(3394, 3386, '北屯', '北屯区', '中国,台湾省,台中市,北屯区', 3, 'beitun', '04', '406', 'B', '120.686250', '24.182220'),
(3395, 3386, '丰原', '丰原区', '中国,台湾省,台中市,丰原区', 3, 'fengyuan', '04', '420', 'F', '120.718460', '24.242190'),
(3396, 3386, '东势', '东势区', '中国,台湾省,台中市,东势区', 3, 'dongshi', '04', '423', 'D', '120.827770', '24.258610'),
(3397, 3386, '大甲', '大甲区', '中国,台湾省,台中市,大甲区', 3, 'dajia', '04', '437', 'D', '120.622390', '24.348920'),
(3398, 3386, '清水', '清水区', '中国,台湾省,台中市,清水区', 3, 'qingshui', '04', '436', 'Q', '120.559780', '24.268650'),
(3399, 3386, '沙鹿', '沙鹿区', '中国,台湾省,台中市,沙鹿区', 3, 'shalu', '04', '433', 'S', '120.565700', '24.233480'),
(3400, 3386, '梧栖', '梧栖区', '中国,台湾省,台中市,梧栖区', 3, 'wuqi', '04', '435', 'W', '120.531520', '24.254960'),
(3401, 3386, '后里', '后里区', '中国,台湾省,台中市,后里区', 3, 'houli', '04', '421', 'H', '120.710710', '24.304910'),
(3402, 3386, '神冈', '神冈区', '中国,台湾省,台中市,神冈区', 3, 'shengang', '04', '429', 'S', '120.661550', '24.257770'),
(3403, 3386, '潭子', '潭子区', '中国,台湾省,台中市,潭子区', 3, 'tanzi', '04', '427', 'T', '120.705160', '24.209530'),
(3404, 3386, '大雅', '大雅区', '中国,台湾省,台中市,大雅区', 3, 'daya', '04', '428', 'D', '120.647780', '24.229230'),
(3405, 3386, '新社', '新社区', '中国,台湾省,台中市,新社区', 3, 'xinshe', '04', '426', 'X', '120.809500', '24.234140'),
(3406, 3386, '石冈', '石冈区', '中国,台湾省,台中市,石冈区', 3, 'shigang', '04', '422', 'S', '120.780410', '24.274980'),
(3407, 3386, '外埔', '外埔区', '中国,台湾省,台中市,外埔区', 3, 'waipu', '04', '438', 'W', '120.654370', '24.332010'),
(3408, 3386, '大安', '大安区', '中国,台湾省,台中市,大安区', 3, 'da\'an', '04', '439', 'D', '120.58652', '24.34607'),
(3409, 3386, '乌日', '乌日区', '中国,台湾省,台中市,乌日区', 3, 'wuri', '04', '414', 'W', '120.623810', '24.104500'),
(3410, 3386, '大肚', '大肚区', '中国,台湾省,台中市,大肚区', 3, 'dadu', '04', '432', 'D', '120.540960', '24.153660'),
(3411, 3386, '龙井', '龙井区', '中国,台湾省,台中市,龙井区', 3, 'longjing', '04', '434', 'L', '120.545940', '24.192710'),
(3412, 3386, '雾峰', '雾峰区', '中国,台湾省,台中市,雾峰区', 3, 'wufeng', '04', '413', 'W', '120.700200', '24.061520'),
(3413, 3386, '太平', '太平区', '中国,台湾省,台中市,太平区', 3, 'taiping', '04', '411', 'T', '120.718523', '24.126472'),
(3414, 3386, '大里', '大里区', '中国,台湾省,台中市,大里区', 3, 'dali', '04', '412', 'D', '120.677860', '24.099390'),
(3415, 3386, '和平', '和平区', '中国,台湾省,台中市,和平区', 3, 'heping', '04', '424', 'H', '120.88349', '24.17477'),
(3416, 3325, '台南', '台南市', '中国,台湾省,台南市', 2, 'tainan', '06', '7', 'T', '120.279363', '23.172478'),
(3417, 3416, '东区', '东区', '中国,台湾省,台南市,东区', 3, 'dongqu', '06', '701', 'D', '120.224198', '22.980072'),
(3418, 3416, '南区', '南区', '中国,台湾省,台南市,南区', 3, 'nanqu', '06', '702', 'N', '120.188648', '22.960944'),
(3419, 3416, '北区', '北区', '中国,台湾省,台南市,北区', 3, 'beiqu', '06', '704', 'B', '120.682410', '24.166040'),
(3420, 3416, '安南', '安南区', '中国,台湾省,台南市,安南区', 3, 'annan', '06', '709', 'A', '120.184617', '23.047230'),
(3421, 3416, '安平', '安平区', '中国,台湾省,台南市,安平区', 3, 'anping', '06', '708', 'A', '120.166810', '23.000763'),
(3422, 3416, '中西', '中西区', '中国,台湾省,台南市,中西区', 3, 'zhongxi', '06', '700', 'Z', '120.205957', '22.992152'),
(3423, 3416, '新营', '新营区', '中国,台湾省,台南市,新营区', 3, 'xinying', '06', '730', 'X', '120.316698', '23.310274'),
(3424, 3416, '盐水', '盐水区', '中国,台湾省,台南市,盐水区', 3, 'yanshui', '06', '737', 'Y', '120.266398', '23.319828'),
(3425, 3416, '白河', '白河区', '中国,台湾省,台南市,白河区', 3, 'baihe', '06', '732', 'B', '120.415810', '23.351221'),
(3426, 3416, '柳营', '柳营区', '中国,台湾省,台南市,柳营区', 3, 'liuying', '06', '736', 'L', '120.311286', '23.278133'),
(3427, 3416, '后壁', '后壁区', '中国,台湾省,台南市,后壁区', 3, 'houbi', '06', '731', 'H', '120.362726', '23.366721'),
(3428, 3416, '东山', '东山区', '中国,台湾省,台南市,东山区', 3, 'dongshan', '06', '733', 'D', '120.403984', '23.326092'),
(3429, 3416, '麻豆', '麻豆区', '中国,台湾省,台南市,麻豆区', 3, 'madou', '06', '721', 'M', '120.248179', '23.181680'),
(3430, 3416, '下营', '下营区', '中国,台湾省,台南市,下营区', 3, 'xiaying', '06', '735', 'X', '120.264484', '23.235413'),
(3431, 3416, '六甲', '六甲区', '中国,台湾省,台南市,六甲区', 3, 'liujia', '06', '734', 'L', '120.347600', '23.231931'),
(3432, 3416, '官田', '官田区', '中国,台湾省,台南市,官田区', 3, 'guantian', '06', '720', 'G', '120.314374', '23.194652'),
(3433, 3416, '大内', '大内区', '中国,台湾省,台南市,大内区', 3, 'dana', '06', '742', 'D', '120.348853', '23.119460'),
(3434, 3416, '佳里', '佳里区', '中国,台湾省,台南市,佳里区', 3, 'jiali', '06', '722', 'J', '120.177211', '23.165121'),
(3435, 3416, '学甲', '学甲区', '中国,台湾省,台南市,学甲区', 3, 'xuejia', '06', '726', 'X', '120.180255', '23.232348'),
(3436, 3416, '西港', '西港区', '中国,台湾省,台南市,西港区', 3, 'xigang', '06', '723', 'X', '120.203618', '23.123057'),
(3437, 3416, '七股', '七股区', '中国,台湾省,台南市,七股区', 3, 'qigu', '06', '724', 'Q', '120.140003', '23.140545'),
(3438, 3416, '将军', '将军区', '中国,台湾省,台南市,将军区', 3, 'jiangjun', '06', '725', 'J', '120.156871', '23.199543'),
(3439, 3416, '北门', '北门区', '中国,台湾省,台南市,北门区', 3, 'beimen', '06', '727', 'B', '120.125821', '23.267148'),
(3440, 3416, '新化', '新化区', '中国,台湾省,台南市,新化区', 3, 'xinhua', '06', '712', 'X', '120.310807', '23.038533'),
(3441, 3416, '善化', '善化区', '中国,台湾省,台南市,善化区', 3, 'shanhua', '06', '741', 'S', '120.296895', '23.132261'),
(3442, 3416, '新市', '新市区', '中国,台湾省,台南市,新市区', 3, 'xinshi', '06', '744', 'X', '120.295138', '23.07897'),
(3443, 3416, '安定', '安定区', '中国,台湾省,台南市,安定区', 3, 'anding', '06', '745', 'A', '120.237083', '23.121498'),
(3444, 3416, '山上', '山上区', '中国,台湾省,台南市,山上区', 3, 'shanshang', '06', '743', 'S', '120.352908', '23.103223'),
(3445, 3416, '玉井', '玉井区', '中国,台湾省,台南市,玉井区', 3, 'yujing', '06', '714', 'Y', '120.460110', '23.123859'),
(3446, 3416, '楠西', '楠西区', '中国,台湾省,台南市,楠西区', 3, 'nanxi', '06', '715', NULL, '120.485396', '23.173454'),
(3447, 3416, '南化', '南化区', '中国,台湾省,台南市,南化区', 3, 'nanhua', '06', '716', 'N', '120.477116', '23.042614'),
(3448, 3416, '左镇', '左镇区', '中国,台湾省,台南市,左镇区', 3, 'zuozhen', '06', '713', 'Z', '120.407309', '23.057955'),
(3449, 3416, '仁德', '仁德区', '中国,台湾省,台南市,仁德区', 3, 'rende', '06', '717', 'R', '120.251520', '22.972212'),
(3450, 3416, '归仁', '归仁区', '中国,台湾省,台南市,归仁区', 3, 'guiren', '06', '711', 'G', '120.293791', '22.967081'),
(3451, 3416, '关庙', '关庙区', '中国,台湾省,台南市,关庙区', 3, 'guanmiao', '06', '718', 'G', '120.327689', '22.962949'),
(3452, 3416, '龙崎', '龙崎区', '中国,台湾省,台南市,龙崎区', 3, 'longqi', '06', '719', 'L', '120.360824', '22.965681'),
(3453, 3416, '永康', '永康区', '中国,台湾省,台南市,永康区', 3, 'yongkang', '06', '710', 'Y', '120.257069', '23.026061'),
(3454, 3325, '新竹', '新竹市', '中国,台湾省,新竹市', 2, 'hsinchu', '03', '3', 'X', '120.968798', '24.806738'),
(3455, 3454, '东区', '东区', '中国,台湾省,新竹市,东区', 3, 'dongqu', '03', '300', 'D', '120.970239', '24.801337'),
(3456, 3454, '北区', '北区', '中国,台湾省,新竹市,北区', 3, 'beiqu', '03', '', 'B', '120.682410', '24.166040'),
(3457, 3454, '香山', '香山区', '中国,台湾省,新竹市,香山区', 3, 'xiangshan', '03', '', 'X', '120.956679', '24.768933'),
(3458, 3325, '嘉义', '嘉义市', '中国,台湾省,嘉义市', 2, 'chiayi', '05', '6', 'J', '120.452538', '23.481568'),
(3459, 3458, '东区', '东区', '中国,台湾省,嘉义市,东区', 3, 'dongqu', '05', '600', 'D', '120.458009', '23.486213'),
(3460, 3458, '西区', '西区', '中国,台湾省,嘉义市,西区', 3, 'xiqu', '05', '600', 'X', '120.437493', '23.473029'),
(3461, 3325, '新北', '新北市', '中国,台湾省,新北市', 2, 'newtaipei', '02', '2', 'X', '121.465746', '25.012366'),
(3462, 3461, '板桥', '板桥区', '中国,台湾省,新北市,板桥区', 3, 'banqiao', '02', '220', 'B', '121.459084', '25.009578'),
(3463, 3461, '三重', '三重区', '中国,台湾省,新北市,三重区', 3, 'sanzhong', '02', '241', 'S', '121.488102', '25.061486'),
(3464, 3461, '中和', '中和区', '中国,台湾省,新北市,中和区', 3, 'zhonghe', '02', '235', 'Z', '121.498980', '24.999397'),
(3465, 3461, '永和', '永和区', '中国,台湾省,新北市,永和区', 3, 'yonghe', '02', '234', 'Y', '121.513660', '25.007802'),
(3466, 3461, '新庄', '新庄区', '中国,台湾省,新北市,新庄区', 3, 'xinzhuang', '02', '242', 'X', '121.450413', '25.035947'),
(3467, 3461, '新店', '新店区', '中国,台湾省,新北市,新店区', 3, 'xindian', '02', '231', 'X', '121.541750', '24.967558'),
(3468, 3461, '树林', '树林区', '中国,台湾省,新北市,树林区', 3, 'shulin', '02', '238', 'S', '121.420533', '24.990706'),
(3469, 3461, '莺歌', '莺歌区', '中国,台湾省,新北市,莺歌区', 3, 'yingge', '02', '239', NULL, '121.354573', '24.955413'),
(3470, 3461, '三峡', '三峡区', '中国,台湾省,新北市,三峡区', 3, 'sanxia', '02', '237', 'S', '121.368905', '24.934339'),
(3471, 3461, '淡水', '淡水区', '中国,台湾省,新北市,淡水区', 3, 'danshui', '02', '251', 'D', '121.440915', '25.169452'),
(3472, 3461, '汐止', '汐止区', '中国,台湾省,新北市,汐止区', 3, 'xizhi', '02', '221', 'X', '121.629470', '25.062999'),
(3473, 3461, '瑞芳', '瑞芳区', '中国,台湾省,新北市,瑞芳区', 3, 'ruifang', '02', '224', 'R', '121.810061', '25.108895'),
(3474, 3461, '土城', '土城区', '中国,台湾省,新北市,土城区', 3, 'tucheng', '02', '236', 'T', '121.443348', '24.972201'),
(3475, 3461, '芦洲', '芦洲区', '中国,台湾省,新北市,芦洲区', 3, 'luzhou', '02', '247', 'L', '121.473700', '25.084923'),
(3476, 3461, '五股', '五股区', '中国,台湾省,新北市,五股区', 3, 'wugu', '02', '248', 'W', '121.438156', '25.082743'),
(3477, 3461, '泰山', '泰山区', '中国,台湾省,新北市,泰山区', 3, 'taishan', '02', '243', 'T', '121.430811', '25.058864'),
(3478, 3461, '林口', '林口区', '中国,台湾省,新北市,林口区', 3, 'linkou', '02', '244', 'L', '121.391602', '25.077531'),
(3479, 3461, '深坑', '深坑区', '中国,台湾省,新北市,深坑区', 3, 'shenkeng', '02', '222', 'S', '121.615670', '25.002329'),
(3480, 3461, '石碇', '石碇区', '中国,台湾省,新北市,石碇区', 3, 'shiding', '02', '223', 'S', '121.658567', '24.991679'),
(3481, 3461, '坪林', '坪林区', '中国,台湾省,新北市,坪林区', 3, 'pinglin', '02', '232', 'P', '121.711185', '24.937388'),
(3482, 3461, '三芝', '三芝区', '中国,台湾省,新北市,三芝区', 3, 'sanzhi', '02', '252', 'S', '121.500866', '25.258047'),
(3483, 3461, '石门', '石门区', '中国,台湾省,新北市,石门区', 3, 'shimen', '02', '253', 'S', '121.568491', '25.290412'),
(3484, 3461, '八里', '八里区', '中国,台湾省,新北市,八里区', 3, 'bali', '02', '249', 'B', '121.398227', '25.146680'),
(3485, 3461, '平溪', '平溪区', '中国,台湾省,新北市,平溪区', 3, 'pingxi', '02', '226', 'P', '121.738255', '25.025725'),
(3486, 3461, '双溪', '双溪区', '中国,台湾省,新北市,双溪区', 3, 'shuangxi', '02', '227', 'S', '121.865676', '25.033409'),
(3487, 3461, '贡寮', '贡寮区', '中国,台湾省,新北市,贡寮区', 3, 'gongliao', '02', '228', 'G', '121.908185', '25.022388'),
(3488, 3461, '金山', '金山区', '中国,台湾省,新北市,金山区', 3, 'jinshan', '02', '208', 'J', '121.636427', '25.221883'),
(3489, 3461, '万里', '万里区', '中国,台湾省,新北市,万里区', 3, 'wanli', '02', '207', 'W', '121.688687', '25.181234'),
(3490, 3461, '乌来', '乌来区', '中国,台湾省,新北市,乌来区', 3, 'wulai', '02', '233', 'W', '121.550531', '24.865296'),
(3491, 3325, '宜兰', '宜兰县', '中国,台湾省,宜兰县', 2, 'yilan', '03', '2', 'Y', '121.500000', '24.600000'),
(3492, 3491, '宜兰', '宜兰市', '中国,台湾省,宜兰县,宜兰市', 3, 'yilan', '03', '260', 'Y', '121.753476', '24.751682'),
(3493, 3491, '罗东', '罗东镇', '中国,台湾省,宜兰县,罗东镇', 3, 'luodong', '03', '265', 'L', '121.766919', '24.677033'),
(3494, 3491, '苏澳', '苏澳镇', '中国,台湾省,宜兰县,苏澳镇', 3, 'suao', '03', '270', 'S', '121.842656', '24.594622'),
(3495, 3491, '头城', '头城镇', '中国,台湾省,宜兰县,头城镇', 3, 'toucheng', '03', '261', 'T', '121.823307', '24.859217'),
(3496, 3491, '礁溪', '礁溪乡', '中国,台湾省,宜兰县,礁溪乡', 3, 'jiaoxi', '03', '262', 'J', '121.766680', '24.822345'),
(3497, 3491, '壮围', '壮围乡', '中国,台湾省,宜兰县,壮围乡', 3, 'zhuangwei', '03', '263', 'Z', '121.781619', '24.744949'),
(3498, 3491, '员山', '员山乡', '中国,台湾省,宜兰县,员山乡', 3, 'yuanshan', '03', '264', 'Y', '121.721733', '24.741771'),
(3499, 3491, '冬山', '冬山乡', '中国,台湾省,宜兰县,冬山乡', 3, 'dongshan', '03', '269', 'D', '121.792280', '24.634514'),
(3500, 3491, '五结', '五结乡', '中国,台湾省,宜兰县,五结乡', 3, 'wujie', '03', '268', 'W', '121.798297', '24.684640'),
(3501, 3491, '三星', '三星乡', '中国,台湾省,宜兰县,三星乡', 3, 'sanxing', '03', '266', 'S', '121.003418', '23.775291'),
(3502, 3491, '大同', '大同乡', '中国,台湾省,宜兰县,大同乡', 3, 'datong', '03', '267', 'D', '121.605557', '24.675997'),
(3503, 3491, '南澳', '南澳乡', '中国,台湾省,宜兰县,南澳乡', 3, 'nanao', '03', '272', 'N', '121.799810', '24.465393'),
(3504, 3325, '桃园', '桃园县', '中国,台湾省,桃园县', 2, 'taoyuan', '03', '3', 'T', '121.083000', '25.000000'),
(3505, 3504, '桃园', '桃园市', '中国,台湾省,桃园县,桃园市', 3, 'taoyuan', '03', '330', 'T', '121.301337', '24.993777'),
(3506, 3504, '中坜', '中坜市', '中国,台湾省,桃园县,中坜市', 3, 'zhongli', '03', '320', 'Z', '121.224926', '24.965353'),
(3507, 3504, '平镇', '平镇市', '中国,台湾省,桃园县,平镇市', 3, 'pingzhen', '03', '324', 'P', '121.218359', '24.945752'),
(3508, 3504, '八德', '八德市', '中国,台湾省,桃园县,八德市', 3, 'bade', '03', '334', 'B', '121.284655', '24.928651'),
(3509, 3504, '杨梅', '杨梅市', '中国,台湾省,桃园县,杨梅市', 3, 'yangmei', '03', '326', 'Y', '121.145873', '24.907575'),
(3510, 3504, '芦竹', '芦竹市', '中国,台湾省,桃园县,芦竹市', 3, 'luzhu', '03', '338', 'L', '121.292064', '25.045392'),
(3511, 3504, '大溪', '大溪镇', '中国,台湾省,桃园县,大溪镇', 3, 'daxi', '03', '335', 'D', '121.286962', '24.880584'),
(3512, 3504, '大园', '大园乡', '中国,台湾省,桃园县,大园乡', 3, 'dayuan', '03', '337', 'D', '121.196292', '25.064471'),
(3513, 3504, '龟山', '龟山乡', '中国,台湾省,桃园县,龟山乡', 3, 'guishan', '03', '333', 'G', '121.337767', '24.992517'),
(3514, 3504, '龙潭', '龙潭乡', '中国,台湾省,桃园县,龙潭乡', 3, 'longtan', '03', '325', 'L', '121.216392', '24.863851'),
(3515, 3504, '新屋', '新屋乡', '中国,台湾省,桃园县,新屋乡', 3, 'xinwu', '03', '327', 'X', '121.105801', '24.972203'),
(3516, 3504, '观音', '观音乡', '中国,台湾省,桃园县,观音乡', 3, 'guanyin', '03', '328', 'G', '121.077519', '25.033303'),
(3517, 3504, '复兴', '复兴乡', '中国,台湾省,桃园县,复兴乡', 3, 'fuxing', '03', '336', 'F', '121.352613', '24.820908'),
(3518, 3325, '新竹', '新竹县', '中国,台湾省,新竹县', 2, 'hsinchu', '03', '3', 'X', '121.160000', '24.600000'),
(3519, 3518, '竹北', '竹北市', '中国,台湾省,新竹县,竹北市', 3, 'zhubei', '03', '302', 'Z', '121.004317', '24.839652'),
(3520, 3518, '竹东', '竹东镇', '中国,台湾省,新竹县,竹东镇', 3, 'zhudong', '03', '310', 'Z', '121.086418', '24.733601'),
(3521, 3518, '新埔', '新埔镇', '中国,台湾省,新竹县,新埔镇', 3, 'xinpu', '03', '305', 'X', '121.072804', '24.824820'),
(3522, 3518, '关西', '关西镇', '中国,台湾省,新竹县,关西镇', 3, 'guanxi', '03', '306', 'G', '121.177301', '24.788842'),
(3523, 3518, '湖口', '湖口乡', '中国,台湾省,新竹县,湖口乡', 3, 'hukou', '03', '303', 'H', '121.043691', '24.903943'),
(3524, 3518, '新丰', '新丰乡', '中国,台湾省,新竹县,新丰乡', 3, 'xinfeng', '03', '304', 'X', '120.983006', '24.899600'),
(3525, 3518, '芎林', '芎林乡', '中国,台湾省,新竹县,芎林乡', 3, 'xionglin', '03', '307', NULL, '121.076924', '24.774436'),
(3526, 3518, '横山', '横山乡', '中国,台湾省,新竹县,横山乡', 3, 'hengshan', '03', '312', 'H', '121.116244', '24.720807'),
(3527, 3518, '北埔', '北埔乡', '中国,台湾省,新竹县,北埔乡', 3, 'beipu', '03', '314', 'B', '121.053156', '24.697126'),
(3528, 3518, '宝山', '宝山乡', '中国,台湾省,新竹县,宝山乡', 3, 'baoshan', '03', '308', 'B', '120.985752', '24.760975'),
(3529, 3518, '峨眉', '峨眉乡', '中国,台湾省,新竹县,峨眉乡', 3, 'emei', '03', '315', 'E', '121.015291', '24.686127'),
(3530, 3518, '尖石', '尖石乡', '中国,台湾省,新竹县,尖石乡', 3, 'jianshi', '03', '313', 'J', '121.197802', '24.704360'),
(3531, 3518, '五峰', '五峰乡', '中国,台湾省,新竹县,五峰乡', 3, 'wufeng', '03', '311', 'W', '121.003418', '23.775291'),
(3532, 3325, '苗栗', '苗栗县', '中国,台湾省,苗栗县', 2, 'miaoli', '037', '3', 'M', '120.750000', '24.500000'),
(3533, 3532, '苗栗', '苗栗市', '中国,台湾省,苗栗县,苗栗市', 3, 'miaoli', '037', '360', 'M', '120.818869', '24.561472'),
(3534, 3532, '苑里', '苑里镇', '中国,台湾省,苗栗县,苑里镇', 3, 'yuanli', '037', '358', 'Y', '120.648907', '24.441750'),
(3535, 3532, '通霄', '通霄镇', '中国,台湾省,苗栗县,通霄镇', 3, 'tongxiao', '037', '357', 'T', '120.676700', '24.489087'),
(3536, 3532, '竹南', '竹南镇', '中国,台湾省,苗栗县,竹南镇', 3, 'zhunan', '037', '350', 'Z', '120.872641', '24.685513'),
(3537, 3532, '头份', '头份镇', '中国,台湾省,苗栗县,头份镇', 3, 'toufen', '037', '351', 'T', '120.895188', '24.687993'),
(3538, 3532, '后龙', '后龙镇', '中国,台湾省,苗栗县,后龙镇', 3, 'houlong', '037', '356', 'H', '120.786480', '24.612617'),
(3539, 3532, '卓兰', '卓兰镇', '中国,台湾省,苗栗县,卓兰镇', 3, 'zhuolan', '037', '369', 'Z', '120.823441', '24.309509'),
(3540, 3532, '大湖', '大湖乡', '中国,台湾省,苗栗县,大湖乡', 3, 'dahu', '037', '364', 'D', '120.863641', '24.422547'),
(3541, 3532, '公馆', '公馆乡', '中国,台湾省,苗栗县,公馆乡', 3, 'gongguan', '037', '363', 'G', '120.822983', '24.499108'),
(3542, 3532, '铜锣', '铜锣乡', '中国,台湾省,苗栗县,铜锣乡', 3, 'tongluo', '037', '366', 'T', '121.003418', '23.775291'),
(3543, 3532, '南庄', '南庄乡', '中国,台湾省,苗栗县,南庄乡', 3, 'nanzhuang', '037', '353', 'N', '120.994957', '24.596835'),
(3544, 3532, '头屋', '头屋乡', '中国,台湾省,苗栗县,头屋乡', 3, 'touwu', '037', '362', 'T', '120.846616', '24.574249'),
(3545, 3532, '三义', '三义乡', '中国,台湾省,苗栗县,三义乡', 3, 'sanyi', '037', '367', 'S', '120.742340', '24.350270'),
(3546, 3532, '西湖', '西湖乡', '中国,台湾省,苗栗县,西湖乡', 3, 'xihu', '037', '368', 'X', '121.003418', '23.775291'),
(3547, 3532, '造桥', '造桥乡', '中国,台湾省,苗栗县,造桥乡', 3, 'zaoqiao', '037', '361', 'Z', '120.862399', '24.637537'),
(3548, 3532, '三湾', '三湾乡', '中国,台湾省,苗栗县,三湾乡', 3, 'sanwan', '037', '352', 'S', '120.951484', '24.651051'),
(3549, 3532, '狮潭', '狮潭乡', '中国,台湾省,苗栗县,狮潭乡', 3, 'shitan', '037', '354', 'S', '120.918024', '24.540004'),
(3550, 3532, '泰安', '泰安乡', '中国,台湾省,苗栗县,泰安乡', 3, 'tai\'an', '037', '365', 'T', '120.904441', '24.442600'),
(3551, 3325, '彰化', '彰化县', '中国,台湾省,彰化县', 2, 'changhua', '04', '5', 'Z', '120.416000', '24.000000'),
(3552, 3551, '彰化市', '彰化市', '中国,台湾省,彰化县,彰化市', 3, 'zhanghuashi', '04', '500', 'Z', '120.542294', '24.080911'),
(3553, 3551, '鹿港', '鹿港镇', '中国,台湾省,彰化县,鹿港镇', 3, 'lugang', '04', '505', 'L', '120.435392', '24.056937'),
(3554, 3551, '和美', '和美镇', '中国,台湾省,彰化县,和美镇', 3, 'hemei', '04', '508', 'H', '120.500265', '24.110904'),
(3555, 3551, '线西', '线西乡', '中国,台湾省,彰化县,线西乡', 3, 'xianxi', '04', '507', 'X', '120.465921', '24.128653'),
(3556, 3551, '伸港', '伸港乡', '中国,台湾省,彰化县,伸港乡', 3, 'shengang', '04', '509', 'S', '120.484224', '24.146081'),
(3557, 3551, '福兴', '福兴乡', '中国,台湾省,彰化县,福兴乡', 3, 'fuxing', '04', '506', 'F', '120.443682', '24.047883'),
(3558, 3551, '秀水', '秀水乡', '中国,台湾省,彰化县,秀水乡', 3, 'xiushui', '04', '504', 'X', '120.502658', '24.035267'),
(3559, 3551, '花坛', '花坛乡', '中国,台湾省,彰化县,花坛乡', 3, 'huatan', '04', '503', 'H', '120.538403', '24.029399'),
(3560, 3551, '芬园', '芬园乡', '中国,台湾省,彰化县,芬园乡', 3, 'fenyuan', '04', '502', 'F', '120.629024', '24.013658'),
(3561, 3551, '员林', '员林镇', '中国,台湾省,彰化县,员林镇', 3, 'yuanlin', '04', '510', 'Y', '120.574625', '23.958999'),
(3562, 3551, '溪湖', '溪湖镇', '中国,台湾省,彰化县,溪湖镇', 3, 'xihu', '04', '514', 'X', '120.479144', '23.962315'),
(3563, 3551, '田中', '田中镇', '中国,台湾省,彰化县,田中镇', 3, 'tianzhong', '04', '520', 'T', '120.580629', '23.861718'),
(3564, 3551, '大村', '大村乡', '中国,台湾省,彰化县,大村乡', 3, 'dacun', '04', '515', 'D', '120.540713', '23.993726'),
(3565, 3551, '埔盐', '埔盐乡', '中国,台湾省,彰化县,埔盐乡', 3, 'puyan', '04', '516', 'P', '120.464044', '24.000346'),
(3566, 3551, '埔心', '埔心乡', '中国,台湾省,彰化县,埔心乡', 3, 'puxin', '04', '513', 'P', '120.543568', '23.953019'),
(3567, 3551, '永靖', '永靖乡', '中国,台湾省,彰化县,永靖乡', 3, 'yongjing', '04', '512', 'Y', '120.547775', '23.924703'),
(3568, 3551, '社头', '社头乡', '中国,台湾省,彰化县,社头乡', 3, 'shetou', '04', '511', 'S', '120.582681', '23.896686'),
(3569, 3551, '二水', '二水乡', '中国,台湾省,彰化县,二水乡', 3, 'ershui', '04', '530', 'E', '120.618788', '23.806995'),
(3570, 3551, '北斗', '北斗镇', '中国,台湾省,彰化县,北斗镇', 3, 'beidou', '04', '521', 'B', '120.520449', '23.870911'),
(3571, 3551, '二林', '二林镇', '中国,台湾省,彰化县,二林镇', 3, 'erlin', '04', '526', 'E', '120.374468', '23.899751'),
(3572, 3551, '田尾', '田尾乡', '中国,台湾省,彰化县,田尾乡', 3, 'tianwei', '04', '522', 'T', '120.524717', '23.890735'),
(3573, 3551, '埤头', '埤头乡', '中国,台湾省,彰化县,埤头乡', 3, 'pitou', '04', '523', NULL, '120.462599', '23.891324'),
(3574, 3551, '芳苑', '芳苑乡', '中国,台湾省,彰化县,芳苑乡', 3, 'fangyuan', '04', '528', 'F', '120.320329', '23.924222'),
(3575, 3551, '大城', '大城乡', '中国,台湾省,彰化县,大城乡', 3, 'dacheng', '04', '527', 'D', '120.320934', '23.852382'),
(3576, 3551, '竹塘', '竹塘乡', '中国,台湾省,彰化县,竹塘乡', 3, 'zhutang', '04', '525', 'Z', '120.427499', '23.860112'),
(3577, 3551, '溪州', '溪州乡', '中国,台湾省,彰化县,溪州乡', 3, 'xizhou', '04', '524', 'X', '120.498706', '23.851229'),
(3578, 3325, '南投', '南投县', '中国,台湾省,南投县', 2, 'nantou', '049', '5', 'N', '120.830000', '23.830000'),
(3579, 3578, '南投市', '南投市', '中国,台湾省,南投县,南投市', 3, 'nantoushi', '049', '540', 'N', '120.683706', '23.909956'),
(3580, 3578, '埔里', '埔里镇', '中国,台湾省,南投县,埔里镇', 3, 'puli', '049', '545', 'P', '120.964648', '23.964789'),
(3581, 3578, '草屯', '草屯镇', '中国,台湾省,南投县,草屯镇', 3, 'caotun', '049', '542', 'C', '120.680343', '23.973947'),
(3582, 3578, '竹山', '竹山镇', '中国,台湾省,南投县,竹山镇', 3, 'zhushan', '049', '557', 'Z', '120.672007', '23.757655'),
(3583, 3578, '集集', '集集镇', '中国,台湾省,南投县,集集镇', 3, 'jiji', '049', '552', 'J', '120.783673', '23.829013'),
(3584, 3578, '名间', '名间乡', '中国,台湾省,南投县,名间乡', 3, 'mingjian', '049', '551', 'M', '120.702797', '23.838427'),
(3585, 3578, '鹿谷', '鹿谷乡', '中国,台湾省,南投县,鹿谷乡', 3, 'lugu', '049', '558', 'L', '120.752796', '23.744471'),
(3586, 3578, '中寮', '中寮乡', '中国,台湾省,南投县,中寮乡', 3, 'zhongliao', '049', '541', 'Z', '120.766654', '23.878935'),
(3587, 3578, '鱼池', '鱼池乡', '中国,台湾省,南投县,鱼池乡', 3, 'yuchi', '049', '555', 'Y', '120.936060', '23.896356'),
(3588, 3578, '国姓', '国姓乡', '中国,台湾省,南投县,国姓乡', 3, 'guoxing', '049', '544', 'G', '120.858541', '24.042298'),
(3589, 3578, '水里', '水里乡', '中国,台湾省,南投县,水里乡', 3, 'shuili', '049', '553', 'S', '120.855912', '23.812086'),
(3590, 3578, '信义', '信义乡', '中国,台湾省,南投县,信义乡', 3, 'xinyi', '049', '556', 'X', '120.855257', '23.699922'),
(3591, 3578, '仁爱', '仁爱乡', '中国,台湾省,南投县,仁爱乡', 3, 'renai', '049', '546', 'R', '121.133543', '24.024429'),
(3592, 3325, '云林', '云林县', '中国,台湾省,云林县', 2, 'yunlin', '05', '6', 'Y', '120.250000', '23.750000'),
(3593, 3592, '斗六', '斗六市', '中国,台湾省,云林县,斗六市', 3, 'douliu', '05', '640', 'D', '120.527360', '23.697651'),
(3594, 3592, '斗南', '斗南镇', '中国,台湾省,云林县,斗南镇', 3, 'dounan', '05', '630', 'D', '120.479075', '23.679731'),
(3595, 3592, '虎尾', '虎尾镇', '中国,台湾省,云林县,虎尾镇', 3, 'huwei', '05', '632', 'H', '120.445339', '23.708182'),
(3596, 3592, '西螺', '西螺镇', '中国,台湾省,云林县,西螺镇', 3, 'xiluo', '05', '648', 'X', '120.466010', '23.797984'),
(3597, 3592, '土库', '土库镇', '中国,台湾省,云林县,土库镇', 3, 'tuku', '05', '633', 'T', '120.392572', '23.677822'),
(3598, 3592, '北港', '北港镇', '中国,台湾省,云林县,北港镇', 3, 'beigang', '05', '651', 'B', '120.302393', '23.575525'),
(3599, 3592, '古坑', '古坑乡', '中国,台湾省,云林县,古坑乡', 3, 'gukeng', '05', '646', 'G', '120.562043', '23.642568'),
(3600, 3592, '大埤', '大埤乡', '中国,台湾省,云林县,大埤乡', 3, 'dapi', '05', '631', 'D', '120.430516', '23.645908'),
(3601, 3592, '莿桐', '莿桐乡', '中国,台湾省,云林县,莿桐乡', 3, 'citong', '05', '647', NULL, '120.502374', '23.760784'),
(3602, 3592, '林内', '林内乡', '中国,台湾省,云林县,林内乡', 3, 'linna', '05', '643', 'L', '120.611365', '23.758712'),
(3603, 3592, '二仑', '二仑乡', '中国,台湾省,云林县,二仑乡', 3, 'erlun', '05', '649', 'E', '120.415077', '23.771273'),
(3604, 3592, '仑背', '仑背乡', '中国,台湾省,云林县,仑背乡', 3, 'lunbei', '05', '637', 'L', '120.353895', '23.758840'),
(3605, 3592, '麦寮', '麦寮乡', '中国,台湾省,云林县,麦寮乡', 3, 'mailiao', '05', '638', 'M', '120.252043', '23.753841'),
(3606, 3592, '东势', '东势乡', '中国,台湾省,云林县,东势乡', 3, 'dongshi', '05', '635', 'D', '120.252672', '23.674679'),
(3607, 3592, '褒忠', '褒忠乡', '中国,台湾省,云林县,褒忠乡', 3, 'baozhong', '05', '634', 'B', '120.310488', '23.694245'),
(3608, 3592, '台西', '台西乡', '中国,台湾省,云林县,台西乡', 3, 'taixi', '05', '636', 'T', '120.196141', '23.702819'),
(3609, 3592, '元长', '元长乡', '中国,台湾省,云林县,元长乡', 3, 'yuanchang', '05', '655', 'Y', '120.315124', '23.649458'),
(3610, 3592, '四湖', '四湖乡', '中国,台湾省,云林县,四湖乡', 3, 'sihu', '05', '654', 'S', '120.225741', '23.637740'),
(3611, 3592, '口湖', '口湖乡', '中国,台湾省,云林县,口湖乡', 3, 'kouhu', '05', '653', 'K', '120.185370', '23.582406'),
(3612, 3592, '水林', '水林乡', '中国,台湾省,云林县,水林乡', 3, 'shuilin', '05', '652', 'S', '120.245948', '23.572634'),
(3613, 3325, '嘉义', '嘉义县', '中国,台湾省,嘉义县', 2, 'chiayi', '05', '6', 'J', '120.300000', '23.500000'),
(3614, 3613, '太保', '太保市', '中国,台湾省,嘉义县,太保市', 3, 'taibao', '05', '612', 'T', '120.332876', '23.459647'),
(3615, 3613, '朴子', '朴子市', '中国,台湾省,嘉义县,朴子市', 3, 'puzi', '05', '613', 'P', '120.247014', '23.464961'),
(3616, 3613, '布袋', '布袋镇', '中国,台湾省,嘉义县,布袋镇', 3, 'budai', '05', '625', 'B', '120.166936', '23.377979'),
(3617, 3613, '大林', '大林镇', '中国,台湾省,嘉义县,大林镇', 3, 'dalin', '05', '622', 'D', '120.471336', '23.603815'),
(3618, 3613, '民雄', '民雄乡', '中国,台湾省,嘉义县,民雄乡', 3, 'minxiong', '05', '621', 'M', '120.428577', '23.551456'),
(3619, 3613, '溪口', '溪口乡', '中国,台湾省,嘉义县,溪口乡', 3, 'xikou', '05', '623', 'X', '120.393822', '23.602223'),
(3620, 3613, '新港', '新港乡', '中国,台湾省,嘉义县,新港乡', 3, 'xingang', '05', '616', 'X', '120.347647', '23.551806'),
(3621, 3613, '六脚', '六脚乡', '中国,台湾省,嘉义县,六脚乡', 3, 'liujiao', '05', '615', 'L', '120.291083', '23.493942'),
(3622, 3613, '东石', '东石乡', '中国,台湾省,嘉义县,东石乡', 3, 'dongshi', '05', '614', 'D', '120.153822', '23.459235'),
(3623, 3613, '义竹', '义竹乡', '中国,台湾省,嘉义县,义竹乡', 3, 'yizhu', '05', '624', 'Y', '120.243423', '23.336277'),
(3624, 3613, '鹿草', '鹿草乡', '中国,台湾省,嘉义县,鹿草乡', 3, 'lucao', '05', '611', 'L', '120.308370', '23.410784'),
(3625, 3613, '水上', '水上乡', '中国,台湾省,嘉义县,水上乡', 3, 'shuishang', '05', '608', 'S', '120.397936', '23.428104'),
(3626, 3613, '中埔', '中埔乡', '中国,台湾省,嘉义县,中埔乡', 3, 'zhongpu', '05', '606', 'Z', '120.522948', '23.425148'),
(3627, 3613, '竹崎', '竹崎乡', '中国,台湾省,嘉义县,竹崎乡', 3, 'zhuqi', '05', '604', 'Z', '120.551466', '23.523184'),
(3628, 3613, '梅山', '梅山乡', '中国,台湾省,嘉义县,梅山乡', 3, 'meishan', '05', '603', 'M', '120.557192', '23.584915'),
(3629, 3613, '番路', '番路乡', '中国,台湾省,嘉义县,番路乡', 3, 'fanlu', '05', '602', 'F', '120.555043', '23.465222'),
(3630, 3613, '大埔', '大埔乡', '中国,台湾省,嘉义县,大埔乡', 3, 'dapu', '05', '607', 'D', '120.593795', '23.296715'),
(3631, 3613, '阿里山', '阿里山乡', '中国,台湾省,嘉义县,阿里山乡', 3, 'alishan', '05', '605', 'A', '120.732520', '23.467950'),
(3632, 3325, '屏东', '屏东县', '中国,台湾省,屏东县', 2, 'pingtung', '08', '9', 'P', '120.487928', '22.682802'),
(3633, 3632, '屏东', '屏东市', '中国,台湾省,屏东县,屏东市', 3, 'pingdong', '08', '900', 'P', '120.488465', '22.669723'),
(3634, 3632, '潮州', '潮州镇', '中国,台湾省,屏东县,潮州镇', 3, 'chaozhou', '08', '920', 'C', '120.542854', '22.550536'),
(3635, 3632, '东港', '东港镇', '中国,台湾省,屏东县,东港镇', 3, 'donggang', '08', '928', 'D', '120.454489', '22.466626'),
(3636, 3632, '恒春', '恒春镇', '中国,台湾省,屏东县,恒春镇', 3, 'hengchun', '08', '946', 'H', '120.745451', '22.002373'),
(3637, 3632, '万丹', '万丹乡', '中国,台湾省,屏东县,万丹乡', 3, 'wandan', '08', '913', 'W', '120.484533', '22.589839'),
(3638, 3632, '长治', '长治乡', '中国,台湾省,屏东县,长治乡', 3, 'changzhi', '08', '908', 'C', '120.527614', '22.677062'),
(3639, 3632, '麟洛', '麟洛乡', '中国,台湾省,屏东县,麟洛乡', 3, 'linluo', '08', '909', NULL, '120.527283', '22.650604'),
(3640, 3632, '九如', '九如乡', '中国,台湾省,屏东县,九如乡', 3, 'jiuru', '08', '904', 'J', '120.490142', '22.739778'),
(3641, 3632, '里港', '里港乡', '中国,台湾省,屏东县,里港乡', 3, 'ligang', '08', '905', 'L', '120.494490', '22.779220'),
(3642, 3632, '盐埔', '盐埔乡', '中国,台湾省,屏东县,盐埔乡', 3, 'yanpu', '08', '907', 'Y', '120.572849', '22.754783'),
(3643, 3632, '高树', '高树乡', '中国,台湾省,屏东县,高树乡', 3, 'gaoshu', '08', '906', 'G', '120.600214', '22.826789'),
(3644, 3632, '万峦', '万峦乡', '中国,台湾省,屏东县,万峦乡', 3, 'wanluan', '08', '923', 'W', '120.566477', '22.571965'),
(3645, 3632, '内埔', '内埔乡', '中国,台湾省,屏东县,内埔乡', 3, 'napu', '08', '912', 'N', '120.566865', '22.611967'),
(3646, 3632, '竹田', '竹田乡', '中国,台湾省,屏东县,竹田乡', 3, 'zhutian', '08', '911', 'Z', '120.544038', '22.584678'),
(3647, 3632, '新埤', '新埤乡', '中国,台湾省,屏东县,新埤乡', 3, 'xinpi', '08', '925', 'X', '120.549546', '22.469976'),
(3648, 3632, '枋寮', '枋寮乡', '中国,台湾省,屏东县,枋寮乡', 3, 'fangliao', '08', '940', NULL, '120.593438', '22.365560'),
(3649, 3632, '新园', '新园乡', '中国,台湾省,屏东县,新园乡', 3, 'xinyuan', '08', '932', 'X', '120.461739', '22.543952'),
(3650, 3632, '崁顶', '崁顶乡', '中国,台湾省,屏东县,崁顶乡', 3, 'kanding', '08', '924', NULL, '120.514571', '22.514795'),
(3651, 3632, '林边', '林边乡', '中国,台湾省,屏东县,林边乡', 3, 'linbian', '08', '927', 'L', '120.515091', '22.434015'),
(3652, 3632, '南州', '南州乡', '中国,台湾省,屏东县,南州乡', 3, 'nanzhou', '08', '926', 'N', '120.509808', '22.490192'),
(3653, 3632, '佳冬', '佳冬乡', '中国,台湾省,屏东县,佳冬乡', 3, 'jiadong', '08', '931', 'J', '120.551544', '22.417653'),
(3654, 3632, '琉球', '琉球乡', '中国,台湾省,屏东县,琉球乡', 3, 'liuqiu', '08', '929', 'L', '120.369020', '22.342366'),
(3655, 3632, '车城', '车城乡', '中国,台湾省,屏东县,车城乡', 3, 'checheng', '08', '944', 'C', '120.710979', '22.072077'),
(3656, 3632, '满州', '满州乡', '中国,台湾省,屏东县,满州乡', 3, 'manzhou', '08', '947', 'M', '120.838843', '22.020853'),
(3657, 3632, '枋山', '枋山乡', '中国,台湾省,屏东县,枋山乡', 3, 'fangshan', '08', '941', NULL, '120.656356', '22.260338'),
(3658, 3632, '三地门', '三地门乡', '中国,台湾省,屏东县,三地门乡', 3, 'sandimen', '08', '901', 'S', '120.654486', '22.713877'),
(3659, 3632, '雾台', '雾台乡', '中国,台湾省,屏东县,雾台乡', 3, 'wutai', '08', '902', 'W', '120.732318', '22.744877'),
(3660, 3632, '玛家', '玛家乡', '中国,台湾省,屏东县,玛家乡', 3, 'majia', '08', '903', 'M', '120.644130', '22.706718'),
(3661, 3632, '泰武', '泰武乡', '中国,台湾省,屏东县,泰武乡', 3, 'taiwu', '08', '921', 'T', '120.632856', '22.591819'),
(3662, 3632, '来义', '来义乡', '中国,台湾省,屏东县,来义乡', 3, 'laiyi', '08', '922', 'L', '120.633601', '22.525866'),
(3663, 3632, '春日', '春日乡', '中国,台湾省,屏东县,春日乡', 3, 'chunri', '08', '942', 'C', '120.628793', '22.370672'),
(3664, 3632, '狮子', '狮子乡', '中国,台湾省,屏东县,狮子乡', 3, 'shizi', '08', '943', 'S', '120.704617', '22.201917'),
(3665, 3632, '牡丹', '牡丹乡', '中国,台湾省,屏东县,牡丹乡', 3, 'mudan', '08', '945', 'M', '120.770108', '22.125687'),
(3666, 3325, '台东', '台东县', '中国,台湾省,台东县', 2, 'taitung', '089', '9', 'T', '120.916000', '23.000000'),
(3667, 3666, '台东', '台东市', '中国,台湾省,台东县,台东市', 3, 'taidong', '089', '950', 'T', '121.145654', '22.756045'),
(3668, 3666, '成功', '成功镇', '中国,台湾省,台东县,成功镇', 3, 'chenggong', '089', '961', 'C', '121.379571', '23.100223'),
(3669, 3666, '关山', '关山镇', '中国,台湾省,台东县,关山镇', 3, 'guanshan', '089', '956', 'G', '121.163134', '23.047450'),
(3670, 3666, '卑南', '卑南乡', '中国,台湾省,台东县,卑南乡', 3, 'beinan', '089', '954', 'B', '121.083503', '22.786039'),
(3671, 3666, '鹿野', '鹿野乡', '中国,台湾省,台东县,鹿野乡', 3, 'luye', '089', '955', 'L', '121.135982', '22.913951'),
(3672, 3666, '池上', '池上乡', '中国,台湾省,台东县,池上乡', 3, 'chishang', '089', '958', 'C', '121.215139', '23.122393'),
(3673, 3666, '东河', '东河乡', '中国,台湾省,台东县,东河乡', 3, 'donghe', '089', '959', 'D', '121.300334', '22.969934'),
(3674, 3666, '长滨', '长滨乡', '中国,台湾省,台东县,长滨乡', 3, 'changbin', '089', '962', 'C', '121.451522', '23.315041'),
(3675, 3666, '太麻里', '太麻里乡', '中国,台湾省,台东县,太麻里乡', 3, 'taimali', '089', '963', 'T', '121.007394', '22.615383'),
(3676, 3666, '大武', '大武乡', '中国,台湾省,台东县,大武乡', 3, 'dawu', '089', '965', 'D', '120.889938', '22.339919'),
(3677, 3666, '绿岛', '绿岛乡', '中国,台湾省,台东县,绿岛乡', 3, 'lvdao', '089', '951', 'L', '121.492596', '22.661676'),
(3678, 3666, '海端', '海端乡', '中国,台湾省,台东县,海端乡', 3, 'haiduan', '089', '957', 'H', '121.172008', '23.101074'),
(3679, 3666, '延平', '延平乡', '中国,台湾省,台东县,延平乡', 3, 'yanping', '089', '953', 'Y', '121.084499', '22.902358'),
(3680, 3666, '金峰', '金峰乡', '中国,台湾省,台东县,金峰乡', 3, 'jinfeng', '089', '964', 'J', '120.971292', '22.595511'),
(3681, 3666, '达仁', '达仁乡', '中国,台湾省,台东县,达仁乡', 3, 'daren', '089', '966', 'D', '120.884131', '22.294869'),
(3682, 3666, '兰屿', '兰屿乡', '中国,台湾省,台东县,兰屿乡', 3, 'lanyu', '089', '952', 'L', '121.532473', '22.056736'),
(3683, 3325, '花莲', '花莲县', '中国,台湾省,花莲县', 2, 'hualien', '03', '9', 'H', '121.300000', '23.830000'),
(3684, 3683, '花莲', '花莲市', '中国,台湾省,花莲县,花莲市', 3, 'hualian', '03', '970', 'H', '121.606810', '23.982074'),
(3685, 3683, '凤林', '凤林镇', '中国,台湾省,花莲县,凤林镇', 3, 'fenglin', '03', '975', 'F', '121.451687', '23.744648'),
(3686, 3683, '玉里', '玉里镇', '中国,台湾省,花莲县,玉里镇', 3, 'yuli', '03', '981', 'Y', '121.316445', '23.336509'),
(3687, 3683, '新城', '新城乡', '中国,台湾省,花莲县,新城乡', 3, 'xincheng', '03', '971', 'X', '121.640512', '24.128133'),
(3688, 3683, '吉安', '吉安乡', '中国,台湾省,花莲县,吉安乡', 3, 'ji\'an', '03', '973', 'J', '121.568005', '23.961635'),
(3689, 3683, '寿丰', '寿丰乡', '中国,台湾省,花莲县,寿丰乡', 3, 'shoufeng', '03', '974', 'S', '121.508955', '23.870680'),
(3690, 3683, '光复', '光复乡', '中国,台湾省,花莲县,光复乡', 3, 'guangfu', '03', '976', 'G', '121.423496', '23.669084'),
(3691, 3683, '丰滨', '丰滨乡', '中国,台湾省,花莲县,丰滨乡', 3, 'fengbin', '03', '977', 'F', '121.518639', '23.597080'),
(3692, 3683, '瑞穗', '瑞穗乡', '中国,台湾省,花莲县,瑞穗乡', 3, 'ruisui', '03', '978', 'R', '121.375992', '23.496817'),
(3693, 3683, '富里', '富里乡', '中国,台湾省,花莲县,富里乡', 3, 'fuli', '03', '983', 'F', '121.250124', '23.179984'),
(3694, 3683, '秀林', '秀林乡', '中国,台湾省,花莲县,秀林乡', 3, 'xiulin', '03', '972', 'X', '121.620381', '24.116642'),
(3695, 3683, '万荣', '万荣乡', '中国,台湾省,花莲县,万荣乡', 3, 'wanrong', '03', '979', 'W', '121.407493', '23.715346'),
(3696, 3683, '卓溪', '卓溪乡', '中国,台湾省,花莲县,卓溪乡', 3, 'zhuoxi', '03', '982', 'Z', '121.303422', '23.346369'),
(3697, 3325, '澎湖', '澎湖县', '中国,台湾省,澎湖县', 2, 'penghu', '06', '8', 'P', '119.566417', '23.569733'),
(3698, 3697, '马公', '马公市', '中国,台湾省,澎湖县,马公市', 3, 'magong', '06', '880', 'M', '119.566499', '23.565845'),
(3699, 3697, '湖西', '湖西乡', '中国,台湾省,澎湖县,湖西乡', 3, 'huxi', '06', '885', 'H', '119.659666', '23.583358'),
(3700, 3697, '白沙', '白沙乡', '中国,台湾省,澎湖县,白沙乡', 3, 'baisha', '06', '884', 'B', '119.597919', '23.666060'),
(3701, 3697, '西屿', '西屿乡', '中国,台湾省,澎湖县,西屿乡', 3, 'xiyu', '06', '881', 'X', '119.506974', '23.600836'),
(3702, 3697, '望安', '望安乡', '中国,台湾省,澎湖县,望安乡', 3, 'wang\'an', '06', '882', 'W', '119.500538', '23.357531'),
(3703, 3697, '七美', '七美乡', '中国,台湾省,澎湖县,七美乡', 3, 'qimei', '06', '883', 'Q', '119.423929', '23.206018'),
(3704, 3325, '金门', '金门县', '中国,台湾省,金门县', 2, 'jinmen', '082', '8', 'J', '118.317089', '24.432706'),
(3705, 3704, '金城', '金城镇', '中国,台湾省,金门县,金城镇', 3, 'jincheng', '082', '893', 'J', '118.316667', '24.416667'),
(3706, 3704, '金湖', '金湖镇', '中国,台湾省,金门县,金湖镇', 3, 'jinhu', '082', '891', 'J', '118.419743', '24.438633'),
(3707, 3704, '金沙', '金沙镇', '中国,台湾省,金门县,金沙镇', 3, 'jinsha', '082', '890', 'J', '118.427993', '24.481109'),
(3708, 3704, '金宁', '金宁乡', '中国,台湾省,金门县,金宁乡', 3, 'jinning', '082', '892', 'J', '118.334506', '24.45672'),
(3709, 3704, '烈屿', '烈屿乡', '中国,台湾省,金门县,烈屿乡', 3, 'lieyu', '082', '894', 'L', '118.247255', '24.433102'),
(3710, 3704, '乌丘', '乌丘乡', '中国,台湾省,金门县,乌丘乡', 3, 'wuqiu', '082', '896', 'W', '118.319578', '24.435038'),
(3711, 3325, '连江', '连江县', '中国,台湾省,连江县', 2, 'lienchiang', '0836', '2', 'L', '119.539704', '26.197364'),
(3712, 3711, '南竿', '南竿乡', '中国,台湾省,连江县,南竿乡', 3, 'nangan', '0836', '209', 'N', '119.944267', '26.144035'),
(3713, 3711, '北竿', '北竿乡', '中国,台湾省,连江县,北竿乡', 3, 'beigan', '0836', '210', 'B', '120.000572', '26.221983'),
(3714, 3711, '莒光', '莒光乡', '中国,台湾省,连江县,莒光乡', 3, 'juguang', '0836', '211', NULL, '119.940405', '25.976256'),
(3715, 3711, '东引', '东引乡', '中国,台湾省,连江县,东引乡', 3, 'dongyin', '0836', '212', 'D', '120.493955', '26.366164'),
...
(3999, 3716, '香港', '香港特别行政区', '中国,香港特别行政区', 2, 'hongkong', NULL, NULL, NULL, NULL, NULL),
(4000, 3999, '中西区', '中西区', '中国,香港特别行政区,中西区', 3, 'zhongxin', NULL, NULL, NULL, NULL, NULL),
(4001, 3999, '东区', '东区', '中国,香港特别行政区,东区', 3, 'dong', NULL, NULL, NULL, NULL, NULL),
(4002, 3999, '九龙城区', '九龙城区', '中国,香港特别行政区,九龙城区', 3, 'jiulong', NULL, NULL, NULL, NULL, NULL),
(4003, 3999, '观塘区', '观塘区', '中国,香港特别行政区,观塘区', 3, 'guantang', NULL, NULL, NULL, NULL, NULL),
(4004, 3999, '南区', '南区', '中国,香港特别行政区,南区', 3, 'nan', NULL, NULL, NULL, NULL, NULL),
(4005, 3999, '深水埗区', '深水埗区', '中国,香港特别行政区,深水埗区', 3, 'shenshuibu', NULL, NULL, NULL, NULL, NULL),
(4006, 3999, '湾仔区', '湾仔区', '中国,香港特别行政区,湾仔区', 3, 'wanzi', NULL, NULL, NULL, NULL, NULL),
(4007, 3999, '黄大仙区', '黄大仙区', '中国,香港特别行政区,黄大仙区', 3, 'huangdaxian', NULL, NULL, NULL, NULL, NULL),
(4008, 3999, '油尖旺区', '油尖旺区', '中国,香港特别行政区,油尖旺区', 3, 'youjianwang', NULL, NULL, NULL, NULL, NULL),
(4009, 3999, '离岛区', '离岛区', '中国,香港特别行政区,离岛区', 3, 'lidao', NULL, NULL, NULL, NULL, NULL),
(4010, 3999, '葵青区', '葵青区', '中国,香港特别行政区,葵青区', 3, 'kuiqing', NULL, NULL, NULL, NULL, NULL),
(4011, 3999, '北区', '北区', '中国,香港特别行政区,北区', 3, 'bei', NULL, NULL, NULL, NULL, NULL),
(4012, 3999, '西贡区', '西贡区', '中国,香港特别行政区,西贡区', 3, 'xigong', NULL, NULL, NULL, NULL, NULL),
(4013, 3999, '沙田区', '沙田区', '中国,香港特别行政区,沙田区', 3, 'shatian', NULL, NULL, NULL, NULL, NULL),
(4014, 3999, '屯门区', '屯门区', '中国,香港特别行政区,屯门区', 3, 'tunmen', NULL, NULL, NULL, NULL, NULL),
(4015, 3999, '大埔区', '大埔区', '中国,香港特别行政区,大埔区', 3, 'dapu', NULL, NULL, NULL, NULL, NULL),
(4016, 3999, '荃湾区', '荃湾区', '中国,香港特别行政区,荃湾区', 3, 'quanwan', NULL, NULL, NULL, NULL, NULL),
(4017, 3999, '元朗区', '元朗区', '中国,香港特别行政区,元朗区', 3, 'yuanlang', NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_return_address`
--

CREATE TABLE `yoshop_return_address` (
  `address_id` int(11) UNSIGNED NOT NULL COMMENT '退货地址id',
  `name` varchar(30) NOT NULL DEFAULT '' COMMENT '收货人姓名',
  `phone` varchar(20) NOT NULL DEFAULT '' COMMENT '联系电话',
  `detail` varchar(255) NOT NULL DEFAULT '' COMMENT '详细地址',
  `sort` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '排序 (数字越小越靠前)',
...
--
-- 转存表中的数据 `yoshop_setting`
--

INSERT INTO `yoshop_setting` (`key`, `describe`, `values`, `wxapp_id`, `update_time`) VALUES
('full_free', '满额包邮设置', '{\"is_open\":\"0\",\"money\":\"\",\"notin_region\":{\"province\":[],\"citys\":[],\"treeData\":[]},\"notin_goods\":[]}', 10003, 1606447503),
('printer', '小票打印机设置', '{\"is_open\":\"0\",\"printer_id\":\"\",\"order_status\":[]}', 10003, 1606447503),
('recharge', '用户充值设置', '{\"is_custom\":\"1\",\"is_match_plan\":\"1\",\"describe\":\"1. \\u8d26\\u6237\\u5145\\u503c\\u4ec5\\u9650\\u5fae\\u4fe1\\u5728\\u7ebf\\u65b9\\u5f0f\\u652f\\u4ed8\\uff0c\\u5145\\u503c\\u91d1\\u989d\\u5b9e\\u65f6\\u5230\\u8d26\\uff1b\\n2. \\u8d26\\u6237\\u5145\\u503c\\u5957\\u9910\\u8d60\\u9001\\u7684\\u91d1\\u989d\\u5373\\u65f6\\u5230\\u8d26\\uff1b\\n3. \\u8d26\\u6237\\u4f59\\u989d\\u6709\\u6548\\u671f\\uff1a\\u81ea\\u5145\\u503c\\u65e5\\u8d77\\u81f3\\u7528\\u5b8c\\u5373\\u6b62\\uff1b\\n4. \\u82e5\\u6709\\u5176\\u5b83\\u7591\\u95ee\\uff0c\\u53ef\\u62e8\\u6253\\u5ba2\\u670d\\u7535\\u8bdd400-000-1234\"}', 10003, 1606447503),
('sms', '短信通知', '{\"default\":\"aliyun\",\"engine\":{\"aliyun\":{\"AccessKeyId\":\"\",\"AccessKeySecret\":\"\",\"sign\":\"\\u8424\\u706b\\u79d1\\u6280\",\"order_pay\":{\"is_enable\":\"0\",\"template_code\":\"\",\"accept_phone\":\"\"}}}}', 10003, 1606447503),
('storage', '上传设置', '{\"default\":\"local\",\"engine\":{\"qiniu\":{\"bucket\":\"\",\"access_key\":\"\",\"secret_key\":\"\",\"domain\":\"http:\\/\\/\"},\"aliyun\":{\"bucket\":\"\",\"access_key_id\":\"\",\"access_key_secret\":\"\",\"domain\":\"http:\\/\\/\"},\"qcloud\":{\"bucket\":\"\",\"region\":\"\",\"secret_id\":\"\",\"secret_key\":\"\",\"domain\":\"http:\\/\\/\"}}}', 10001, 1535945598),
('storage', '上传设置', '{\"default\":\"local\",\"engine\":{\"local\":[],\"qiniu\":{\"bucket\":\"\",\"access_key\":\"\",\"secret_key\":\"\",\"domain\":\"http:\\/\\/\"},\"aliyun\":{\"bucket\":\"\",\"access_key_id\":\"\",\"access_key_secret\":\"\",\"domain\":\"http:\\/\\/\"},\"qcloud\":{\"bucket\":\"\",\"region\":\"\",\"secret_id\":\"\",\"secret_key\":\"\",\"domain\":\"http:\\/\\/\"}}}', 10003, 1606447503),
('store', '商城设置', '{\"name\":\"\\u8f6e\\u80ce\",\"delivery_type\":[\"10\"],\"kuaidi100\":{\"customer\":\"\",\"key\":\"\"}}', 10001, 1606460213),
('store', '商城设置', '{\"name\":\"\\u8f6e\\u80ce\",\"delivery_type\":[10,20],\"kuaidi100\":{\"customer\":\"\",\"key\":\"\"}}', 10003, 1606447503),
('tplMsg', '模板消息', '{\"payment\":{\"is_enable\":\"0\",\"template_id\":\"\"},\"delivery\":{\"is_enable\":\"0\",\"template_id\":\"\"},\"refund\":{\"is_enable\":\"0\",\"template_id\":\"\"}}', 10003, 1606447503),
('trade', '交易设置', '{\"order\":{\"close_days\":\"3\",\"receive_days\":\"10\",\"refund_days\":\"7\"},\"freight_rule\":\"10\"}', 10003, 1606447503);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_sharing_active`
--

CREATE TABLE `yoshop_sharing_active` (
  `active_id` int(11) UNSIGNED NOT NULL COMMENT '拼单id',
...
--
-- 表的结构 `yoshop_sharing_active_users`
--
...
--
-- 转存表中的数据 `yoshop_sharing_category`
--

INSERT INTO `yoshop_sharing_category` (`category_id`, `name`, `parent_id`, `image_id`, `sort`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '轮胎', 0, 0, 100, 10001, 1606444867, 1606444867);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_sharing_comment`
--
...
--
-- 表的结构 `yoshop_sharing_comment_image`
--
...
--
-- 表的结构 `yoshop_sharing_goods`
--

CREATE TABLE `yoshop_sharing_goods` (
  `goods_id` int(11) UNSIGNED NOT NULL COMMENT '拼团商品id',
  `goods_name` varchar(255) NOT NULL DEFAULT '' COMMENT '商品名称',
  `category_id` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '商品分类id',
  `selling_point` varchar(500) NOT NULL DEFAULT '' COMMENT '商品卖点',
...
--
-- 转存表中的数据 `yoshop_sharing_goods`
--

INSERT INTO `yoshop_sharing_goods` (`goods_id`, `goods_name`, `category_id`, `selling_point`, `people`, `group_time`, `is_alone`, `spec_type`, `deduct_stock_type`, `content`, `sales_initial`, `sales_actual`, `goods_sort`, `delivery_id`, `is_enable_grade`, `is_alone_grade`, `alone_grade_equity`, `is_ind_dealer`, `dealer_money_type`, `first_money`, `second_money`, `third_money`, `goods_status`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '米其林', 10001, '', 2, 24, 0, 20, 10, '&lt;p&gt;test&lt;/p&gt;', 0, 0, 100, 10001, 1, 0, NULL, 0, 10, '0.00', '0.00', '0.00', 10, 0, 10001, 1606444903, 1606444903);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_sharing_goods_image`
--
...
--
-- 转存表中的数据 `yoshop_sharing_goods_image`
--

INSERT INTO `yoshop_sharing_goods_image` (`id`, `goods_id`, `image_id`, `wxapp_id`, `create_time`) VALUES
(10001, 10001, 10001, 10001, 1606444904);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_sharing_goods_sku`
--
...
--
-- 转存表中的数据 `yoshop_sharing_goods_sku`
--

INSERT INTO `yoshop_sharing_goods_sku` (`goods_sku_id`, `goods_id`, `spec_sku_id`, `image_id`, `goods_no`, `sharing_price`, `goods_price`, `line_price`, `stock_num`, `goods_sales`, `goods_weight`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 10001, '10001_10004', 0, '', '1.00', '2.00', '3.00', 4, 0, 1, 10001, 1606444904, 1606444904),
(10002, 10001, '10001_10005', 0, '', '1.00', '2.00', '3.00', 4, 0, 1, 10001, 1606444904, 1606444904),
(10003, 10001, '10002_10004', 0, '', '1.00', '2.00', '3.00', 4, 0, 1, 10001, 1606444904, 1606444904),
(10004, 10001, '10002_10005', 0, '', '1.00', '2.00', '3.00', 4, 0, 1, 10001, 1606444904, 1606444904),
(10005, 10001, '10003_10004', 0, '', '1.00', '2.00', '3.00', 4, 0, 1, 10001, 1606444904, 1606444904),
(10006, 10001, '10003_10005', 0, '', '1.50', '2.00', '3.00', 4, 0, 1, 10001, 1606444904, 1606444904);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_sharing_goods_spec_rel`
--
...
--
-- 转存表中的数据 `yoshop_sharing_goods_spec_rel`
--

INSERT INTO `yoshop_sharing_goods_spec_rel` (`id`, `goods_id`, `spec_id`, `spec_value_id`, `wxapp_id`, `create_time`) VALUES
(10001, 10001, 10001, 10001, 10001, 1606444903),
(10002, 10001, 10001, 10002, 10001, 1606444904),
(10003, 10001, 10001, 10003, 10001, 1606444904),
(10004, 10001, 10002, 10004, 10001, 1606444904),
(10005, 10001, 10002, 10005, 10001, 1606444904);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_sharing_order`
--
...
--
-- 表的结构 `yoshop_sharing_order_address`
--
...
--
-- 表的结构 `yoshop_sharing_order_extract`
--
...
--
-- 表的结构 `yoshop_sharing_order_goods`
--
...
--
-- 表的结构 `yoshop_sharing_order_refund`
--
...
--
-- 表的结构 `yoshop_sharing_order_refund_address`
--
...
--
-- 表的结构 `yoshop_sharing_order_refund_image`
--
...
INSERT INTO `yoshop_spec` (`spec_id`, `spec_name`, `wxapp_id`, `create_time`) VALUES
(10001, 'test', 10001, 1606439609),
(10002, '纹路', 10001, 1606439635);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_spec_value`
--
...
--
-- 转存表中的数据 `yoshop_spec_value`
--

INSERT INTO `yoshop_spec_value` (`spec_value_id`, `spec_value`, `spec_id`, `wxapp_id`, `create_time`) VALUES
(10001, '123', 10001, 10001, 1606439609),
(10002, '134', 10001, 10001, 1606439614),
(10003, '1', 10001, 10001, 1606439618),
(10004, 'X', 10002, 10001, 1606439636),
(10005, 'Y', 10002, 10001, 1606439639);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_store_access`
--
...
--
-- 转存表中的数据 `yoshop_store_access`
--

INSERT INTO `yoshop_store_access` (`access_id`, `name`, `url`, `parent_id`, `sort`, `create_time`, `update_time`) VALUES
(10001, '首页', 'index/index', 0, 100, 1540628721, 1540781975),
(10002, '管理员', 'store', 0, 105, 1540628721, 1552635011),
(10003, '管理员管理', 'store.user', 10002, 100, 1540628721, 1540628721),
(10004, '管理员列表', 'store.user/index', 10003, 100, 1540628721, 1540628721),
(10005, '添加管理员', 'store.user/add', 10003, 100, 1540628721, 1540628721),
(10006, '编辑管理员', 'store.user/edit', 10003, 100, 1540628721, 1540628721),
(10007, '删除管理员', 'store.user/delete', 10003, 100, 1540628721, 1540628721),
(10008, '角色管理', 'store.role', 10002, 100, 1540628721, 1540628721),
(10009, '角色列表', 'store.role/index', 10008, 100, 1540628721, 1540628721),
(10010, '添加角色', 'store.role/add', 10008, 100, 1540628721, 1540628721),
(10011, '编辑角色', 'store.role/edit', 10008, 100, 1540628721, 1540628721),
(10012, '删除角色', 'store.role/delete', 10008, 100, 1540628721, 1540628721),
(10018, '商品管理', 'goods', 0, 110, 1540628721, 1552635017),
(10019, '商品管理', 'goods', 10018, 100, 1540628721, 1540628721),
(10020, '商品列表', 'goods/index', 10019, 100, 1540628721, 1540628721),
(10021, '添加商品', 'goods/add', 10019, 100, 1540628721, 1540628721),
(10022, '编辑商品', 'goods/edit', 10019, 100, 1540628721, 1540628721),
(10023, '复制商品', 'goods/copy', 10019, 100, 1540628721, 1540628721),
(10024, '删除商品', 'goods/delete', 10019, 100, 1540628721, 1540628721),
(10025, '商品上下架', 'goods/state', 10019, 100, 1540628721, 1540628721),
(10026, '商品分类', 'goods.category', 10018, 100, 1540628721, 1540628721),
(10027, '分类列表', 'goods.category/index', 10026, 100, 1540628721, 1540628721),
(10028, '添加分类', 'goods.category/add', 10026, 100, 1540628721, 1540628721),
(10029, '编辑分类', 'goods.category/edit', 10026, 100, 1540628721, 1540628721),
(10030, '删除分类', 'goods.category/delete', 10026, 100, 1540628721, 1540628721),
(10031, '商品评价', 'goods.comment', 10018, 100, 1540628721, 1540628721),
(10032, '评价列表', 'goods.comment/index', 10031, 100, 1540628721, 1540628721),
(10033, '评价详情', 'goods.comment/detail', 10031, 100, 1540628721, 1540628721),
(10034, '删除评价', 'goods.comment/delete', 10031, 100, 1540628721, 1540628721),
(10035, '订单管理', 'order', 0, 115, 1540628721, 1552635035),
(10036, '订单列表', '', 10035, 100, 1540628721, 1540628721),
(10037, '待发货', 'order/delivery_list', 10036, 100, 1540628721, 1540628721),
(10038, '待收货', 'order/receipt_list', 10036, 100, 1540628721, 1540628721),
(10039, '待付款', 'order/pay_list', 10036, 100, 1540628721, 1540628721),
(10040, '已完成', 'order/complete_list', 10036, 100, 1540628721, 1540628721),
(10041, '已取消', 'order/cancel_list', 10036, 100, 1540628721, 1540628721),
(10042, '全部订单', 'order/all_list', 10036, 100, 1540628721, 1540628721),
(10043, '订单详情', '', 10035, 100, 1540628721, 1540628721),
(10044, '详情信息', 'order/detail', 10043, 100, 1540628721, 1540628721),
(10045, '确认发货', 'order/delivery', 10043, 100, 1540628721, 1540628721),
(10046, '修改订单价格', 'order/updateprice', 10043, 100, 1540628721, 1540628721),
(10047, '订单导出', 'order.operate/export', 10035, 100, 1540628721, 1540628721),
(10048, '批量发货', 'order.operate/batchdelivery', 10035, 100, 1540628721, 1540628721),
(10049, '用户管理', 'user', 0, 120, 1540628721, 1552635042),
(10050, '用户列表', 'user/index', 10049, 100, 1540628721, 1540628721),
(10051, '删除用户', 'user/delete', 10049, 105, 1540628721, 1540628721),
(10052, '营销管理', 'market', 0, 135, 1540628721, 1552635080),
(10053, '优惠券', 'coupon', 10052, 100, 1540628721, 1540628721),
(10054, '优惠券列表', 'market.coupon/index', 10053, 100, 1540628721, 1540628721),
(10055, '新增优惠券', 'market.coupon/add', 10053, 100, 1540628721, 1540628721),
(10056, '编辑优惠券', 'market.coupon/edit', 10053, 100, 1540628721, 1540628721),
(10057, '删除优惠券', 'market.coupon/delete', 10053, 100, 1540628721, 1540628721),
(10058, '领取记录', 'market.coupon/receive', 10053, 100, 1540628721, 1540628721),
(10059, '小程序', 'wxapp', 0, 140, 1540628721, 1552635087),
(10060, '小程序设置', 'wxapp/setting', 10059, 100, 1540628721, 1540628721),
(10061, '页面管理', 'wxapp.page', 10059, 100, 1540628721, 1540628721),
(10062, '页面设计', '', 10061, 100, 1540628721, 1540628721),
(10063, '页面列表', 'wxapp.page/index', 10062, 100, 1540628721, 1540628721),
(10064, '新增页面', 'wxapp.page/add', 10062, 100, 1540628721, 1540628721),
(10065, '编辑页面', 'wxapp.page/edit', 10062, 100, 1540628721, 1540628721),
(10066, '设为首页', 'wxapp.page/sethome', 10062, 100, 1540628721, 1540628721),
(10067, '分类页模板', 'wxapp.page/category', 10061, 100, 1540628721, 1540628721),
(10068, '页面链接', 'wxapp.page/links', 10061, 100, 1540628721, 1540628721),
(10069, '帮助中心', 'wxapp.help', 10059, 100, 1540628721, 1540628721),
(10070, '帮助列表', 'wxapp.help/index', 10069, 100, 1540628721, 1540628721),
(10071, '新增帮助', 'wxapp.help/add', 10069, 100, 1540628721, 1540628721),
(10072, '编辑帮助', 'wxapp.help/edit', 10069, 100, 1540628721, 1540628721),
(10073, '删除帮助', 'wxapp.help/delete', 10069, 100, 1540628721, 1540628721),
(10074, '应用中心', 'apps', 0, 145, 1540628721, 1552635094),
(10075, '分销中心', 'apps.dealer', 10074, 100, 1540628721, 1540628721),
(10076, '入驻申请', 'apps.dealer.apply', 10075, 100, 1540628721, 1540628721),
(10077, '申请列表', 'apps.dealer.apply/index', 10076, 100, 1540628721, 1540628721),
(10078, '分销商审核', 'apps.dealer.apply/submit', 10076, 100, 1540628721, 1540628721),
(10079, '分销商用户', 'apps.dealer.user', 10075, 100, 1540628721, 1540628721),
(10080, '分销商列表', 'apps.dealer.user/index', 10079, 100, 1540628721, 1540628721),
(10081, '删除分销商', 'apps.dealer.user/delete', 10079, 100, 1540628721, 1540628721),
(10082, '分销商二维码', 'apps.dealer.user/qrcode', 10079, 100, 1540628721, 1540628721),
(10083, '分销订单', 'apps.dealer.order/index', 10075, 100, 1540628721, 1540628721),
(10084, '提现申请', 'apps.dealer.withdraw', 10075, 100, 1540628721, 1540628721),
(10085, '申请列表', 'apps.dealer.withdraw/index', 10084, 100, 1540628721, 1540628721),
(10086, '提现审核', 'apps.dealer.withdraw/submit', 10084, 100, 1540628721, 1540628721),
(10087, '确认打款', 'apps.dealer.withdraw/money', 10084, 100, 1540628721, 1540628721),
(10088, '分销设置', 'apps.dealer.setting/index', 10075, 100, 1540628721, 1540628721),
(10089, '分销海报', 'apps.dealer.setting/qrcode', 10075, 100, 1540628721, 1540628721),
(10090, '设置', 'setting', 0, 150, 1540628721, 1552635100),
(10091, '商城设置', 'setting/store', 10090, 100, 1540628721, 1540628721),
(10092, '交易设置', 'setting/trade', 10090, 100, 1540628721, 1540628721),
(10093, '运费模板', 'setting.delivery', 10090, 100, 1540628721, 1540628721),
(10094, '运费模板列表', 'setting.delivery/index', 10093, 100, 1540628721, 1540628721),
(10095, '新增运费模板', 'setting.delivery/add', 10093, 100, 1540628721, 1540628721),
(10096, '编辑运费模板', 'setting.delivery/edit', 10093, 100, 1540628721, 1540628721),
(10097, '删除运费模板', 'setting.delivery/delete', 10093, 100, 1540628721, 1540628721),
(10098, '物流公司', 'setting.express', 10090, 100, 1540628721, 1540628721),
(10099, '物流公司列表', 'setting.express/index', 10098, 100, 1540628721, 1540628721),
(10100, '新增物流公司', 'setting.express/add', 10098, 100, 1540628721, 1540628721),
(10101, '编辑物流公司', 'setting.express/edit', 10098, 100, 1540628721, 1540628721),
(10102, '删除物流公司', 'setting.express/delete', 10098, 100, 1540628721, 1540628721),
(10103, '短信通知', 'setting/sms', 10090, 100, 1540628721, 1540628721),
(10104, '模板消息', 'setting/tplmsg', 10090, 100, 1540628721, 1540628721),
(10105, '上传设置', 'setting/storage', 10090, 100, 1540628721, 1540628721),
(10106, '其他', '', 10090, 100, 1540628721, 1540628721),
(10107, '清理缓存', 'setting.cache/clear', 10106, 100, 1540628721, 1540628721),
(10108, '审核用户取消申请', 'order.operate/confirmcancel', 10043, 100, 1542163260, 1542163260),
(10109, '售后管理', 'order.refund', 10035, 100, 1542161684, 1542161684),
(10110, '售后列表', 'order.refund/index', 10109, 100, 1542161714, 1542161714),
(10111, '售后详情', 'order.refund/detail', 10109, 100, 1542161736, 1542161736),
(10112, '审核售后单', 'order.refund/audit', 10109, 100, 1542162196, 1542162196),
(10113, '确认收货并退款', 'order.refund/receipt', 10109, 100, 1542162231, 1542162231),
(10114, '退货地址管理', 'setting.address', 10090, 100, 1542609573, 1542609573),
(10115, '退货地址列表', 'setting.address/index', 10114, 100, 1542609598, 1542609598),
(10116, '新增退货地址', 'setting.address/add', 10114, 100, 1542609630, 1542609630),
(10117, '编辑退货地址', 'setting.address/edit', 10114, 100, 1542609656, 1542609656),
(10118, '删除退货地址', 'setting.address/delete', 10114, 100, 1542609680, 1542609680),
(10300, '拼团管理', 'apps.sharing', 10074, 100, 1544601161, 1544601161),
(10301, '商品分类', 'apps.sharing.category', 10300, 100, 1544601378, 1544601378),
(10302, '分类列表', 'apps.sharing.category/index', 10301, 100, 1544601378, 1544601378),
(10303, '添加分类', 'apps.sharing.category/add', 10301, 100, 1544601378, 1544601378),
(10304, '编辑分类', 'apps.sharing.category/edit', 10301, 100, 1544601378, 1544601378),
(10305, '删除分类', 'apps.sharing.category/delete', 10301, 100, 1544601378, 1544601378),
(10306, '商品管理', 'apps.sharing.goods', 10300, 100, 1544601378, 1544601378),
(10307, '商品列表', 'apps.sharing.goods/index', 10306, 100, 1544601378, 1544601378),
(10308, '添加商品', 'apps.sharing.goods/add', 10306, 100, 1544601378, 1544601378),
(10309, '编辑商品', 'apps.sharing.goods/edit', 10306, 100, 1544601378, 1544601378),
(10310, '复制商品', 'apps.sharing.goods/copy', 10306, 100, 1544601378, 1544601378),
(10311, '删除商品', 'apps.sharing.goods/delete', 10306, 100, 1544601378, 1544601378),
(10312, '商品上下架', 'apps.sharing.goods/state', 10306, 100, 1544601378, 1544601378),
(10313, '拼单管理', 'apps.sharing.active', 10300, 100, 1544601378, 1544601378),
(10314, '拼单列表', 'apps.sharing.active/index', 10313, 100, 1544601378, 1544601378),
(10315, '拼单成员列表', 'apps.sharing.active/users', 10313, 100, 1544601378, 1544601378),
(10316, '订单管理', 'apps.sharing.order', 10300, 100, 1544601378, 1544601378),
(10317, '订单列表', 'apps.sharing.order/index', 10316, 100, 1544601378, 1544601378),
(10318, '订单详情', '', 10316, 100, 1544601378, 1544601378),
(10319, '详情信息', 'apps.sharing.order/detail', 10318, 100, 1544601378, 1544601378),
(10320, '确认发货', 'apps.sharing.order/delivery', 10318, 100, 1544601378, 1544601378),
(10321, '修改订单价格', 'apps.sharing.order/updateprice', 10318, 100, 1544601378, 1544601378),
(10322, '审核用户取消订单', 'apps.sharing.order/confirmcancel', 10318, 100, 1544601378, 1544601378),
(10323, '拼团失败手动退款', 'apps.sharing.order/refund', 10318, 100, 1544601378, 1544601378),
(10324, '订单导出', 'apps.sharing.order.operate/export', 10316, 100, 1544601378, 1544601378),
(10325, '批量发货', 'apps.sharing.order.operate/batchdelivery', 10316, 100, 1544601378, 1544601378),
(10326, '售后管理', 'apps.sharing.order.refund', 10300, 100, 1544601378, 1544601378),
(10327, '售后列表', 'apps.sharing.order.refund/index', 10326, 100, 1544601378, 1544601378),
(10328, '售后详情', 'apps.sharing.order.refund/detail', 10326, 100, 1544601378, 1544601378),
(10329, '审核售后单', 'apps.sharing.order.refund/audit', 10326, 100, 1544601378, 1544601378),
(10330, '确认收货并退款', 'apps.sharing.order.refund/receipt', 10326, 100, 1544601378, 1544601378),
(10331, '商品评价', 'apps.sharing.comment', 10300, 100, 1544601378, 1544601378),
(10332, '评价列表', 'apps.sharing.comment/index', 10331, 100, 1544601378, 1544601378),
(10333, '评价详情', 'apps.sharing.comment/detail', 10331, 100, 1544601378, 1544601378),
(10334, '删除评价', 'apps.sharing.comment/delete', 10331, 100, 1544601378, 1544601378),
(10335, '拼团设置', 'apps.sharing.setting/index', 10300, 105, 1544601378, 1544601378),
(10336, '下级用户列表', 'apps.dealer.user/fans', 10079, 100, 1545189676, 1545189676),
(10337, '内容管理', 'content', 0, 130, 1547018818, 1552635075),
(10338, '文章管理', 'content.article', 10337, 100, 1547018849, 1547018869),
(10339, '文章列表', 'content.article/index', 10338, 100, 1547018885, 1547018885),
(10340, '添加文章', 'content.article/add', 10338, 100, 1547018901, 1547018901),
(10341, '编辑文章', 'content.article/edit', 10338, 100, 1547018922, 1547018922),
(10342, '删除文章', 'content.article/delete', 10338, 100, 1547018937, 1547018937),
(10343, '文章分类', 'content.article.category', 10337, 100, 1547018972, 1547018972),
(10344, '分类列表', 'content.article.category/index', 10343, 100, 1547018992, 1547018992),
(10345, '添加分类', 'content.article.category/add', 10343, 100, 1547019008, 1547019017),
(10346, '编辑分类', 'content.article.category/edit', 10343, 100, 1547019008, 1547019017),
(10347, '删除分类', 'content.article.category/delete', 10343, 100, 1547019008, 1547019017),
(10348, '微信付款', 'apps.dealer.withdraw/wechat_pay', 10084, 100, 1548232045, 1548232045),
(10349, '小票打印机', 'setting.printer', 10090, 100, 1548738285, 1548738285),
(10350, '打印机管理', 'setting.printer', 10349, 100, 1548738718, 1548738718),
(10351, '小票打印设置', 'setting/printer', 10349, 100, 1548738720, 1548738720),
(10352, '小票打印机列表', 'setting.printer/index', 10350, 100, 1548738420, 1548738420),
(10353, '新增小票打印机', 'setting.printer/add', 10350, 100, 1548738443, 1548738443),
(10354, '编辑小票打印机', 'setting.printer/edit', 10350, 100, 1548738443, 1548738443),
(10355, '删除小票打印机', 'setting.printer/delete', 10350, 100, 1548738443, 1548738443),
(10356, '门店管理', 'shop', 0, 125, 1551504862, 1552635061),
(10357, '门店管理', 'shop', 10356, 105, 1551505016, 1551505016),
(10358, '门店列表', 'shop/index', 10357, 100, 1551505032, 1551505048),
(10359, '添加门店', 'shop/add', 10357, 100, 1551505032, 1551505048),
(10360, '编辑门店', 'shop/edit', 10357, 100, 1551505032, 1551505048),
(10361, '删除门店', 'shop/delete', 10357, 100, 1551505032, 1551505048),
(10362, '店员管理', 'shop.clerk', 10356, 110, 1551505016, 1551505016),
(10363, '店员列表', 'shop.clerk/index', 10362, 100, 1551505032, 1551505048),
(10364, '添加店员', 'shop.clerk/add', 10362, 100, 1551505032, 1551505048),
(10365, '编辑店员', 'shop.clerk/edit', 10362, 100, 1551505032, 1551505048),
(10366, '删除店员', 'shop.clerk/delete', 10362, 100, 1551505032, 1551505048),
(10367, '订单核销记录', 'shop.order/index', 10356, 115, 1551505016, 1551505016),
(10368, '门店自提核销', 'order.operate/extract', 10043, 100, 1551505016, 1551505016),
(10369, '门店自提核销', 'apps.sharing.order.operate/extract', 10318, 100, 1551505016, 1551505016),
(10370, '满额包邮', 'market.basic/full_free', 10052, 120, 1551505016, 1551505016),
(10375, '文件库管理', 'content.files.group', 10337, 105, 1552634170, 1552634170),
(10376, '文件分组', 'content.files.group', 10375, 100, 1552634170, 1552634170),
(10377, '分组列表', 'content.files.group/index', 10376, 100, 1552634170, 1552634170),
(10378, '添加分组', 'content.files.group/add', 10376, 100, 1552634170, 1552634170),
(10379, '编辑分组', 'content.files.group/edit', 10376, 100, 1552634170, 1552634170),
(10380, '删除分组', 'content.files.group/delete', 10376, 100, 1552634170, 1552634170),
(10381, '文件管理', 'content.files.group', 10375, 100, 1552634170, 1552634170),
(10382, '文件列表', 'content.files.group/index', 10381, 105, 1552634170, 1552634170),
(10383, '回收站列表', 'content.files.group/recycle', 10381, 110, 1552634170, 1552634170),
(10384, '移入回收站', 'content.files.group/add', 10381, 115, 1552634170, 1552634170),
(10385, '回收站还原', 'content.files.group/edit', 10381, 120, 1552634170, 1552634170),
(10386, '删除文件', 'content.files.group/delete', 10381, 125, 1552634170, 1552634170),
(10387, '余额记录', 'user.balance', 10049, 125, 1554685953, 1554685965),
(10388, '充值记录', 'user.recharge/order', 10387, 100, 1554686010, 1554686010),
(10389, '余额明细', 'user.balance/log', 10387, 105, 1554686031, 1554686031),
(10390, '用户充值', 'market.recharge', 10052, 110, 1554686283, 1554686339),
(10391, '充值套餐', 'market.recharge.plan', 10390, 100, 1554686316, 1554686316),
(10392, '套餐列表', 'market.recharge.plan/index', 10391, 100, 1554686316, 1554686316),
(10393, '添加套餐', 'market.recharge.plan/add', 10391, 105, 1554686316, 1554686316),
(10394, '编辑套餐', 'market.recharge.plan/edit', 10391, 110, 1554686316, 1554686316),
(10395, '删除套餐', 'market.recharge.plan/delete', 10391, 115, 1554686316, 1554686316),
(10396, '充值设置', 'market.recharge/setting', 10390, 105, 1554686647, 1554686647),
(10400, '好物圈', 'apps.wow', 10074, 110, 1557037952, 1557037952),
(10401, '商品收藏', 'apps.wow.shoping', 10400, 100, 1557037952, 1557037952),
(10402, '订单信息', 'apps.wow.order', 10400, 105, 1557037952, 1557037952),
(10403, '基础设置', 'apps.wow.setting/index', 10400, 110, 1557037952, 1557037952),
(10404, '商品收藏记录', 'apps.wow.shoping/index', 10401, 100, 1557037952, 1557037952),
(10405, '取消同步', 'apps.wow.shoping/delete', 10401, 105, 1557037952, 1557037952),
(10406, '订单同步记录', 'apps.wow.order/index', 10402, 100, 1557037952, 1557037952),
(10407, '取消同步', 'apps.wow.order/delete', 10402, 105, 1557037952, 1557037952),
(10408, '用户充值', 'user/recharge', 10049, 110, 1557037952, 1557037952),
(10411, '修改会员等级', 'user/grade', 10049, 115, 1558317213, 1558317226),
(10412, '会员等级管理', 'user.grade', 10049, 120, 1558317440, 1558317440),
(10413, '会员等级列表', 'user.grade/index', 10412, 100, 1558317464, 1558317464),
(10414, '新增等级', 'user.grade/add', 10412, 105, 1558317464, 1558317464),
(10415, '编辑等级', 'user.grade/edit', 10412, 110, 1558317464, 1558317464),
(10416, '删除等级', 'user.grade/delete', 10412, 115, 1558317464, 1558317464);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_store_role`
--
...
--
-- 转存表中的数据 `yoshop_store_role`
--

INSERT INTO `yoshop_store_role` (`role_id`, `role_name`, `parent_id`, `sort`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '商家', 0, 100, 10001, 1606445532, 1606445532);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_store_role_access`
--
...
--
-- 转存表中的数据 `yoshop_store_role_access`
--

INSERT INTO `yoshop_store_role_access` (`id`, `role_id`, `access_id`, `wxapp_id`, `create_time`) VALUES
(10001, 10001, 10001, 10001, 1606445532),
(10002, 10001, 10002, 10001, 1606445532),
(10003, 10001, 10003, 10001, 1606445532),
(10004, 10001, 10004, 10001, 1606445532),
(10005, 10001, 10005, 10001, 1606445532),
(10006, 10001, 10006, 10001, 1606445532),
(10007, 10001, 10007, 10001, 1606445532),
(10008, 10001, 10008, 10001, 1606445532),
(10009, 10001, 10009, 10001, 1606445532),
(10010, 10001, 10010, 10001, 1606445532),
(10011, 10001, 10011, 10001, 1606445532),
(10012, 10001, 10012, 10001, 1606445532),
(10013, 10001, 10018, 10001, 1606445532),
(10014, 10001, 10019, 10001, 1606445532),
(10015, 10001, 10020, 10001, 1606445532),
(10016, 10001, 10021, 10001, 1606445532),
(10017, 10001, 10022, 10001, 1606445532),
(10018, 10001, 10023, 10001, 1606445532),
(10019, 10001, 10024, 10001, 1606445532),
(10020, 10001, 10025, 10001, 1606445532),
(10021, 10001, 10026, 10001, 1606445532),
(10022, 10001, 10027, 10001, 1606445532),
(10023, 10001, 10028, 10001, 1606445532),
(10024, 10001, 10029, 10001, 1606445532),
(10025, 10001, 10030, 10001, 1606445532),
(10026, 10001, 10031, 10001, 1606445532),
(10027, 10001, 10032, 10001, 1606445532),
(10028, 10001, 10033, 10001, 1606445532),
(10029, 10001, 10034, 10001, 1606445532),
(10030, 10001, 10049, 10001, 1606445532),
(10031, 10001, 10050, 10001, 1606445532),
(10032, 10001, 10051, 10001, 1606445532),
(10033, 10001, 10408, 10001, 1606445532),
(10034, 10001, 10411, 10001, 1606445532),
(10035, 10001, 10412, 10001, 1606445532),
(10036, 10001, 10413, 10001, 1606445532),
(10037, 10001, 10414, 10001, 1606445532),
(10038, 10001, 10415, 10001, 1606445532),
(10039, 10001, 10416, 10001, 1606445532),
(10040, 10001, 10387, 10001, 1606445532),
(10041, 10001, 10388, 10001, 1606445532),
(10042, 10001, 10389, 10001, 1606445532),
(10043, 10001, 10356, 10001, 1606445532),
(10044, 10001, 10357, 10001, 1606445532),
(10045, 10001, 10358, 10001, 1606445532),
(10046, 10001, 10359, 10001, 1606445532),
(10047, 10001, 10360, 10001, 1606445532),
(10048, 10001, 10361, 10001, 1606445532),
(10049, 10001, 10362, 10001, 1606445532),
(10050, 10001, 10363, 10001, 1606445532),
(10051, 10001, 10364, 10001, 1606445532),
(10052, 10001, 10365, 10001, 1606445532),
(10053, 10001, 10366, 10001, 1606445532),
(10054, 10001, 10367, 10001, 1606445532),
(10055, 10001, 10337, 10001, 1606445532),
(10056, 10001, 10338, 10001, 1606445532),
(10057, 10001, 10339, 10001, 1606445532),
(10058, 10001, 10340, 10001, 1606445532),
(10059, 10001, 10341, 10001, 1606445532),
(10060, 10001, 10342, 10001, 1606445532),
(10061, 10001, 10343, 10001, 1606445532),
(10062, 10001, 10344, 10001, 1606445532),
(10063, 10001, 10345, 10001, 1606445532),
(10064, 10001, 10346, 10001, 1606445532),
(10065, 10001, 10347, 10001, 1606445532),
(10066, 10001, 10375, 10001, 1606445532),
(10067, 10001, 10376, 10001, 1606445532),
(10068, 10001, 10377, 10001, 1606445532),
(10069, 10001, 10378, 10001, 1606445532),
(10070, 10001, 10379, 10001, 1606445532),
(10071, 10001, 10380, 10001, 1606445532),
(10072, 10001, 10381, 10001, 1606445532),
(10073, 10001, 10382, 10001, 1606445532),
(10074, 10001, 10383, 10001, 1606445532),
(10075, 10001, 10384, 10001, 1606445532),
(10076, 10001, 10385, 10001, 1606445532),
(10077, 10001, 10386, 10001, 1606445532),
(10078, 10001, 10052, 10001, 1606445532),
(10079, 10001, 10053, 10001, 1606445532),
(10080, 10001, 10054, 10001, 1606445532),
(10081, 10001, 10055, 10001, 1606445532),
(10082, 10001, 10056, 10001, 1606445532),
(10083, 10001, 10057, 10001, 1606445532),
(10084, 10001, 10058, 10001, 1606445532),
(10085, 10001, 10390, 10001, 1606445532),
(10086, 10001, 10391, 10001, 1606445532),
(10087, 10001, 10392, 10001, 1606445532),
(10088, 10001, 10393, 10001, 1606445532),
(10089, 10001, 10394, 10001, 1606445532),
(10090, 10001, 10395, 10001, 1606445532),
(10091, 10001, 10396, 10001, 1606445532),
(10092, 10001, 10370, 10001, 1606445532);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_store_shop`
--
...
--
-- 转存表中的数据 `yoshop_store_shop`
--

INSERT INTO `yoshop_store_shop` (`shop_id`, `shop_name`, `logo_image_id`, `linkman`, `phone`, `shop_hours`, `province_id`, `city_id`, `region_id`, `address`, `longitude`, `latitude`, `geohash`, `summary`, `sort`, `is_check`, `status`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '希梵', 10001, '希梵', '18266666666', '8:30-17:30', 1168, 1183, 1184, '软件园二期', '118.153839', '24.522137', 'wsk588hgzcx', '', 100, 1, 1, 0, 10001, 1606446629, 1606460019);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_store_shop_clerk`
--

CREATE TABLE `yoshop_store_shop_clerk` (
  `clerk_id` int(11) UNSIGNED NOT NULL COMMENT '店员id',
...
--
-- 转存表中的数据 `yoshop_store_user`
--

INSERT INTO `yoshop_store_user` (`store_user_id`, `user_name`, `password`, `real_name`, `is_super`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 'admin', '9ae7b2e6f25c907a1fc81b503b16e25f', '管理员', 1, 0, 10001, 1529926348, 1531027042),
(10002, 'shop', '9c4cb25665cf08667c815420ab383cb5', '', 0, 1, 10001, 1606445566, 1606459888),
(10003, 'shop1', '9c4cb25665cf08667c815420ab383cb5', '', 1, 0, 10003, 1606447503, 1606447503);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_store_user_role`
--
...
--
-- 转存表中的数据 `yoshop_upload_file`
--

INSERT INTO `yoshop_upload_file` (`file_id`, `storage`, `group_id`, `file_url`, `file_name`, `file_size`, `file_type`, `extension`, `is_user`, `is_recycle`, `is_delete`, `wxapp_id`, `create_time`) VALUES
(10001, 'local', 0, '', '20201127091253260e74070.png', 63807, 'image', 'png', 0, 0, 0, 10001, 1606439573),
(10002, 'local', 0, '', '20201127143539e00bf9793.png', 248367, 'image', 'png', 0, 0, 0, 10001, 1606458939);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_upload_group`
--
...
INSERT INTO `yoshop_user` (`user_id`, `open_id`, `nickName`, `avatarUrl`, `gender`, `country`, `province`, `city`, `address_id`, `balance`, `pay_money`, `expend_money`, `grade_id`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 'oEz-R4n6VdKIUxFdJf4LPault3F4', '瑞典', 'https://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTLDrL5uYwMEqziaYTkN6360k6vvZvfZEIIvqrxaBzGPgP61VpalLPUXia2AdCSrZflyCg20X3QvvVaQ/132', 1, '瑞典', '斯德哥尔摩', '', 10001, '0.00', '0.00', '0.00', 0, 0, 10001, 1606441499, 1606465723);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_user_address`
--

CREATE TABLE `yoshop_user_address` (
  `address_id` int(11) UNSIGNED NOT NULL COMMENT '主键id',
  `name` varchar(30) NOT NULL DEFAULT '' COMMENT '收货人姓名',
  `phone` varchar(20) NOT NULL DEFAULT '' COMMENT '联系电话',
  `province_id` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '所在省份id',
  `city_id` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '所在城市id',
...
--
-- 转存表中的数据 `yoshop_user_address`
--

INSERT INTO `yoshop_user_address` (`address_id`, `name`, `phone`, `province_id`, `city_id`, `region_id`, `district`, `detail`, `user_id`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '张三', '020-81167888', 1964, 1965, 1968, '', '新港中路397号', 10001, 10001, 1606444234, 1606444234);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_user_balance_log`
--

CREATE TABLE `yoshop_user_balance_log` (
  `log_id` int(11) UNSIGNED NOT NULL COMMENT '主键id',
  `user_id` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '用户id',
...
--
-- 表的结构 `yoshop_user_coupon`
--

CREATE TABLE `yoshop_user_coupon` (
  `user_coupon_id` int(11) UNSIGNED NOT NULL COMMENT '主键id',
  `coupon_id` int(11) UNSIGNED NOT NULL COMMENT '优惠券id',
  `name` varchar(255) NOT NULL DEFAULT '' COMMENT '优惠券名称',
  `color` tinyint(3) UNSIGNED NOT NULL DEFAULT '10' COMMENT '优惠券颜色(10蓝 20红 30紫 40黄)',
  `coupon_type` tinyint(3) UNSIGNED NOT NULL DEFAULT '10' COMMENT '优惠券类型(10满减券 20折扣券)',
...
--
-- 表的结构 `yoshop_user_grade`
--

CREATE TABLE `yoshop_user_grade` (
  `grade_id` int(11) UNSIGNED NOT NULL COMMENT '等级ID',
...
CREATE TABLE `yoshop_wow_order` (
  ...
  `create_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='好物圈订单同步记录表';

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_wow_setting`
--
...
CREATE TABLE `yoshop_wow_shoping` (
  ...
  `wxapp_id` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='好物圈商品收藏记录表';
...
--
-- 转存表中的数据 `yoshop_wxapp`
--

INSERT INTO `yoshop_wxapp` (`wxapp_id`, `app_id`, `app_secret`, `mchid`, `apikey`, `cert_pem`, `key_pem`, `is_recycle`, `is_delete`, `create_time`, `update_time`) VALUES
(10001, 'wxe28067a465805491', '87cceb8bf7521157fb62a9d195c3fd3d', '1583083831', 'f7eda6ab694b560f2af22e9bb8ccb141', '', '', 0, 0, 1529926348, 1606466413),
(10003, '', '', '', '', NULL, NULL, 0, 0, 1606447503, 1606447503);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_wxapp_category`
--
...
--
-- 转存表中的数据 `yoshop_wxapp_category`
--

INSERT INTO `yoshop_wxapp_category` (`wxapp_id`, `category_style`, `share_title`, `create_time`, `update_time`) VALUES
(10001, 11, '', 1536373988, 1606445087),
(10003, 11, '', 1606447503, 1606447503);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_wxapp_formid`
--
...
--
-- 转存表中的数据 `yoshop_wxapp_formid`
--

INSERT INTO `yoshop_wxapp_formid` (`id`, `user_id`, `form_id`, `expiry_time`, `is_used`, `used_time`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 10001, 'the formId is no longer available in develop or tr', 1607046299, 0, 0, 10001, 1606441509, 1606441509),
(10002, 10001, 'the formId is no longer available in develop or tr', 1607046301, 0, 0, 10001, 1606441511, 1606441511),
(10003, 10001, 'the formId is no longer available in develop or tr', 1607046304, 0, 0, 10001, 1606441514, 1606441514),
(10004, 10001, 'the formId is no longer available in develop or tr', 1607046406, 0, 0, 10001, 1606441616, 1606441616),
(10005, 10001, 'the formId is no longer available in develop or tr', 1607049022, 0, 0, 10001, 1606444232, 1606444232),
(10006, 10001, 'the formId is no longer available in develop or tr', 1607049257, 0, 0, 10001, 1606444467, 1606444467),
(10007, 10001, 'the formId is no longer available in develop or tr', 1607049260, 0, 0, 10001, 1606444470, 1606444470),
(10008, 10001, 'the formId is no longer available in develop or tr', 1607049958, 0, 0, 10001, 1606445168, 1606445168),
(10009, 10001, 'the formId is no longer available in develop or tr', 1607049966, 0, 0, 10001, 1606445176, 1606445176),
(10010, 10001, 'the formId is no longer available in develop or tr', 1607050095, 0, 0, 10001, 1606445305, 1606445305),
(10011, 10001, 'the formId is no longer available in develop or tr', 1607051434, 0, 0, 10001, 1606446644, 1606446644),
(10012, 10001, 'the formId is no longer available in develop or tr', 1607051445, 0, 0, 10001, 1606446655, 1606446655),
(10013, 10001, 'the formId is no longer available in develop or tr', 1607051451, 0, 0, 10001, 1606446661, 1606446661),
(10014, 10001, 'the formId is no longer available in develop or tr', 1607052917, 0, 0, 10001, 1606448127, 1606448127),
(10015, 10001, 'the formId is no longer available in develop or tr', 1607053711, 0, 0, 10001, 1606448921, 1606448921),
(10016, 10001, 'the formId is no longer available in develop or tr', 1607053716, 0, 0, 10001, 1606448926, 1606448926),
(10017, 10001, 'the formId is no longer available in develop or tr', 1607053743, 0, 0, 10001, 1606448953, 1606448953),
(10018, 10001, 'the formId is no longer available in develop or tr', 1607053764, 0, 0, 10001, 1606448974, 1606448974),
(10019, 10001, 'the formId is no longer available in develop or tr', 1607053770, 0, 0, 10001, 1606448980, 1606448980),
(10020, 10001, 'the formId is no longer available in develop or tr', 1607064847, 0, 0, 10001, 1606460057, 1606460057),
(10021, 10001, 'the formId is no longer available in develop or tr', 1607064858, 0, 0, 10001, 1606460068, 1606460068),
(10022, 10001, 'the formId is no longer available in develop or tr', 1607064881, 0, 0, 10001, 1606460091, 1606460091),
(10023, 10001, 'the formId is no longer available in develop or tr', 1607070524, 0, 0, 10001, 1606465734, 1606465734),
(10024, 10001, 'the formId is no longer available in develop or tr', 1607070526, 0, 0, 10001, 1606465736, 1606465736),
(10025, 10001, 'the formId is no longer available in develop or tr', 1607070536, 0, 0, 10001, 1606465746, 1606465746),
(10026, 10001, 'the formId is no longer available in develop or tr', 1607070546, 0, 0, 10001, 1606465756, 1606465756),
(10027, 10001, 'the formId is no longer available in develop or tr', 1607070629, 0, 0, 10001, 1606465839, 1606465839),
(10028, 10001, 'the formId is no longer available in develop or tr', 1607070942, 0, 0, 10001, 1606466152, 1606466152),
(10029, 10001, 'the formId is no longer available in develop or tr', 1607071213, 0, 0, 10001, 1606466423, 1606466423);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_wxapp_help`
--

CREATE TABLE `yoshop_wxapp_help` (
  `help_id` int(11) UNSIGNED NOT NULL COMMENT '主键id',
...
--
-- 转存表中的数据 `yoshop_wxapp_help`
--

INSERT INTO `yoshop_wxapp_help` (`help_id`, `title`, `content`, `sort`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '关于小程序', '小程序本身无需下载，无需注册，不占用手机内存，可以跨平台使用，响应迅速，体验接近原生APP。', 100, 10001, 1535942481, 1535942481),
(10002, '关于小程序', '小程序本身无需下载，无需注册，不占用手机内存，可以跨平台使用，响应迅速，体验接近原生APP。', 100, 10003, 1606447503, 1606447503);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_wxapp_page`
--
...
--
-- 转存表中的数据 `yoshop_wxapp_page`
--

INSERT INTO `yoshop_wxapp_page` (`page_id`, `page_type`, `page_name`, `page_data`, `wxapp_id`, `is_delete`, `create_time`, `update_time`) VALUES
(10001, 10, '页面名称', '{\"page\":{\"type\":\"page\",\"name\":\"\\u9875\\u9762\\u8bbe\\u7f6e\",\"params\":{\"name\":\"\\u9875\\u9762\\u540d\\u79f0\",\"title\":\"\\u8424\\u706b\\u5c0f\\u7a0b\\u5e8f\\u5546\\u57ce\",\"share_title\":\"\\u5206\\u4eab\\u6807\\u9898\"},\"style\":{\"titleTextColor\":\"white\",\"titleBackgroundColor\":\"#ff8000\"},\"id\":\"page\"},\"items\":[{\"name\":\"\\u641c\\u7d22\\u6846\",\"type\":\"search\",\"params\":{\"placeholder\":\"\\u8bf7\\u8f93\\u5165\\u5173\\u952e\\u5b57\\u8fdb\\u884c\\u641c\\u7d22\"},\"style\":{\"textAlign\":\"left\",\"searchStyle\":\"\"},\"id\":\"n50214144672381\"},{\"name\":\"\\u4f18\\u60e0\\u5238\\u7ec4\",\"type\":\"coupon\",\"style\":{\"paddingTop\":\"10\",\"background\":\"#ffffff\"},\"params\":{\"limit\":\"5\"},\"data\":[{\"color\":\"red\",\"reduce_price\":\"10\",\"min_price\":\"100.00\"},{\"color\":\"violet\",\"reduce_price\":\"10\",\"min_price\":\"100.00\"}],\"id\":\"n33356112682143\"},{\"name\":\"\\u5bfc\\u822a\\u7ec4\",\"type\":\"navBar\",\"style\":{\"background\":\"#ffffff\",\"rowsNum\":\"4\"},\"data\":[{\"imgUrl\":\"http:\\/\\/youshop.local.com\\/assets\\/store\\/img\\/diy\\/navbar\\/01.png\",\"imgName\":\"icon-1.png\",\"linkUrl\":\"pages\\/sharing\\/index\\/index\",\"text\":\"\\u62fc\\u56e2\",\"color\":\"#666666\"},{\"imgUrl\":\"http:\\/\\/youshop.local.com\\/assets\\/store\\/img\\/diy\\/navbar\\/01.png\",\"imgName\":\"icon-2.jpg\",\"linkUrl\":\"pages\\/custom\\/index?page_id=10005\",\"text\":\"\\u4f18\\u60e0\\u5238\",\"color\":\"#666666\"},{\"imgUrl\":\"http:\\/\\/youshop.local.com\\/assets\\/store\\/img\\/diy\\/navbar\\/01.png\",\"imgName\":\"icon-3.jpg\",\"linkUrl\":\"\",\"text\":\"\\u6309\\u94ae\\u6587\\u5b573\",\"color\":\"#666666\"},{\"imgUrl\":\"http:\\/\\/youshop.local.com\\/assets\\/store\\/img\\/diy\\/navbar\\/01.png\",\"imgName\":\"icon-4.jpg\",\"linkUrl\":\"\",\"text\":\"\\u6309\\u94ae\\u6587\\u5b574\",\"color\":\"#666666\"}]},{\"name\":\"\\u62fc\\u56e2\\u5546\\u54c1\\u7ec4\",\"type\":\"sharingGoods\",\"params\":{\"source\":\"auto\",\"auto\":{\"category\":0,\"goodsSort\":\"all\",\"showNum\":6}},\"style\":{\"background\":\"#F6F6F6\",\"show\":{\"goodsName\":\"1\",\"sellingPoint\":\"1\",\"sharingPrice\":\"1\",\"linePrice\":\"1\"}},\"defaultData\":[{\"goods_name\":\"\\u6b64\\u5904\\u662f\\u62fc\\u56e2\\u5546\\u54c1\",\"image\":\"http:\\/\\/youshop.local.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png\",\"selling_point\":\"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u6027\\u4ef7\\u6bd4\\u8f83\\u9ad8 \\u4e0d\\u5bb9\\u9519\\u8fc7\",\"sharing_price\":\"99.00\",\"line_price\":\"139.00\"},{\"goods_name\":\"\\u6b64\\u5904\\u662f\\u62fc\\u56e2\\u5546\\u54c1\",\"image\":\"http:\\/\\/youshop.local.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png\",\"selling_point\":\"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u6027\\u4ef7\\u6bd4\\u8f83\\u9ad8 \\u4e0d\\u5bb9\\u9519\\u8fc7\",\"goods_price\":\"99.00\",\"line_price\":\"139.00\"},{\"goods_name\":\"\\u6b64\\u5904\\u662f\\u62fc\\u56e2\\u5546\\u54c1\",\"image\":\"http:\\/\\/youshop.local.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png\",\"selling_point\":\"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u6027\\u4ef7\\u6bd4\\u8f83\\u9ad8 \\u4e0d\\u5bb9\\u9519\\u8fc7\",\"sharing_price\":\"99.00\",\"line_price\":\"139.00\"},{\"goods_name\":\"\\u6b64\\u5904\\u662f\\u62fc\\u56e2\\u5546\\u54c1\",\"image\":\"http:\\/\\/youshop.local.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png\",\"selling_point\":\"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u6027\\u4ef7\\u6bd4\\u8f83\\u9ad8 \\u4e0d\\u5bb9\\u9519\\u8fc7\",\"sharing_price\":\"99.00\",\"line_price\":\"139.00\"}],\"data\":[{\"goods_name\":\"\\u6b64\\u5904\\u662f\\u62fc\\u56e2\\u5546\\u54c1\",\"image\":\"http:\\/\\/youshop.local.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png\",\"selling_point\":\"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u6027\\u4ef7\\u6bd4\\u8f83\\u9ad8 \\u4e0d\\u5bb9\\u9519\\u8fc7\",\"sharing_price\":\"99.00\",\"line_price\":\"139.00\",\"is_default\":true},{\"goods_name\":\"\\u6b64\\u5904\\u662f\\u62fc\\u56e2\\u5546\\u54c1\",\"image\":\"http:\\/\\/youshop.local.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png\",\"selling_point\":\"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u6027\\u4ef7\\u6bd4\\u8f83\\u9ad8 \\u4e0d\\u5bb9\\u9519\\u8fc7\",\"sharing_price\":\"99.00\",\"line_price\":\"139.00\",\"is_default\":true}]},{\"name\":\"\\u5546\\u54c1\\u7ec4\",\"type\":\"goods\",\"params\":{\"source\":\"auto\",\"auto\":{\"category\":0,\"goodsSort\":\"all\",\"showNum\":6}},\"style\":{\"background\":\"#F6F6F6\",\"display\":\"list\",\"column\":\"2\",\"show\":{\"goodsName\":\"1\",\"goodsPrice\":\"1\",\"linePrice\":\"1\",\"sellingPoint\":\"0\",\"goodsSales\":\"0\"}},\"defaultData\":[{\"goods_name\":\"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0\",\"image\":\"http:\\/\\/youshop.local.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png\",\"goods_price\":\"99.00\",\"line_price\":\"139.00\",\"selling_point\":\"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7\",\"goods_sales\":\"100\"},{\"goods_name\":\"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0\",\"image\":\"http:\\/\\/youshop.local.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png\",\"goods_price\":\"99.00\",\"line_price\":\"139.00\",\"selling_point\":\"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7\",\"goods_sales\":\"100\"},{\"goods_name\":\"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0\",\"image\":\"http:\\/\\/youshop.local.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png\",\"goods_price\":\"99.00\",\"line_price\":\"139.00\",\"selling_point\":\"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7\",\"goods_sales\":\"100\"},{\"goods_name\":\"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0\",\"image\":\"http:\\/\\/youshop.local.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png\",\"goods_price\":\"99.00\",\"line_price\":\"139.00\",\"selling_point\":\"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7\",\"goods_sales\":\"100\"}],\"data\":[{\"goods_name\":\"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0\",\"image\":\"http:\\/\\/youshop.local.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png\",\"goods_price\":\"99.00\",\"line_price\":\"139.00\",\"selling_point\":\"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7\",\"goods_sales\":\"100\",\"is_default\":true},{\"goods_name\":\"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0\",\"image\":\"http:\\/\\/youshop.local.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png\",\"goods_price\":\"99.00\",\"line_price\":\"139.00\",\"selling_point\":\"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7\",\"goods_sales\":\"100\",\"is_default\":true}]}]}', 10001, 0, 1536197290, 1606465467),
(10004, 10, '小程序首页', '{\"page\":{\"type\":\"page\",\"name\":\"\\u9875\\u9762\\u8bbe\\u7f6e\",\"params\":{\"name\":\"\\u9875\\u9762\\u6807\\u9898\",\"title\":\"\\u9875\\u9762\\u6807\\u9898\",\"share_title\":\"\\u5206\\u4eab\\u6807\\u9898\"},\"style\":{\"titleTextColor\":\"black\",\"titleBackgroundColor\":\"#ffffff\"}},\"items\":[{\"type\":\"search\",\"name\":\"\\u641c\\u7d22\\u6846\",\"params\":{\"placeholder\":\"\\u641c\\u7d22\\u5546\\u54c1\"},\"style\":{\"textAlign\":\"center\",\"searchStyle\":\"radius\"}},{\"type\":\"banner\",\"name\":\"\\u56fe\\u7247\\u8f6e\\u64ad\",\"style\":{\"btnColor\":\"#ffffff\",\"btnShape\":\"round\"},\"params\":{\"interval\":\"2800\"},\"data\":[{\"imgUrl\":\"http:\\/\\/youshop.local.com\\/assets\\/store\\/img\\/diy\\/banner\\/01.png\",\"linkUrl\":\"\"},{\"imgUrl\":\"http:\\/\\/youshop.local.com\\/assets\\/store\\/img\\/diy\\/banner\\/01.png\",\"linkUrl\":\"\"}]}]}', 10003, 0, 1606447503, 1606447503),
(10005, 20, '优惠券', '{\"page\":{\"type\":\"page\",\"name\":\"\\u9875\\u9762\\u8bbe\\u7f6e\",\"params\":{\"name\":\"\\u4f18\\u60e0\\u5238\",\"title\":\"\\u4f18\\u60e0\\u5238\",\"share_title\":\"\\u4f18\\u60e0\\u5238\"},\"style\":{\"titleTextColor\":\"black\",\"titleBackgroundColor\":\"#ffffff\"}},\"items\":[{\"name\":\"\\u4f18\\u60e0\\u5238\\u7ec4\",\"type\":\"coupon\",\"style\":{\"paddingTop\":\"10\",\"background\":\"#ffffff\"},\"params\":{\"limit\":\"5\"},\"data\":[{\"color\":\"red\",\"reduce_price\":\"10\",\"min_price\":\"100.00\"},{\"color\":\"violet\",\"reduce_price\":\"10\",\"min_price\":\"100.00\"}]}]}', 10001, 0, 1606465310, 1606465564);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_wxapp_prepay_id`
--
...
--
-- 表的索引 `yoshop_admin_user`
--
ALTER TABLE `yoshop_admin_user`
...
-- 表的索引 `yoshop_article`
--
ALTER TABLE `yoshop_article`
  ADD PRIMARY KEY (`article_id`);

--
-- 表的索引 `yoshop_article_category`
--
ALTER TABLE `yoshop_article_category`
  ADD PRIMARY KEY (`category_id`);

--
-- 表的索引 `yoshop_category`
--
...
-- 表的索引 `yoshop_comment`
--
ALTER TABLE `yoshop_comment`
  ADD PRIMARY KEY (`comment_id`);

--
-- 表的索引 `yoshop_comment_image`
--
ALTER TABLE `yoshop_comment_image`
  ADD PRIMARY KEY (`id`);
...
--
-- 表的索引 `yoshop_coupon_goods`
--
ALTER TABLE `yoshop_coupon_goods`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `yoshop_dealer_apply`
--
ALTER TABLE `yoshop_dealer_apply`
  ADD PRIMARY KEY (`apply_id`);

--
-- 表的索引 `yoshop_dealer_capital`
--
ALTER TABLE `yoshop_dealer_capital`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `yoshop_dealer_order`
--
...
--
-- 表的索引 `yoshop_dealer_referee`
--
ALTER TABLE `yoshop_dealer_referee`
  ADD PRIMARY KEY (`id`),
  ADD KEY `dealer_id` (`dealer_id`),
  ADD KEY `user_id` (`user_id`);

--
-- 表的索引 `yoshop_dealer_setting`
--
ALTER TABLE `yoshop_dealer_setting`
  ADD UNIQUE KEY `unique_key` (`key`,`wxapp_id`);

--
-- 表的索引 `yoshop_dealer_user`
--
ALTER TABLE `yoshop_dealer_user`
  ADD PRIMARY KEY (`user_id`);

--
-- 表的索引 `yoshop_dealer_withdraw`
--
ALTER TABLE `yoshop_dealer_withdraw`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `yoshop_delivery`
--
ALTER TABLE `yoshop_delivery`
  ADD PRIMARY KEY (`delivery_id`);

--
-- 表的索引 `yoshop_delivery_rule`
--
ALTER TABLE `yoshop_delivery_rule`
...
ALTER TABLE `yoshop_express`
  ...
  ADD KEY `express_code` (`express_code`);
...
--
-- 表的索引 `yoshop_goods_image`
--
ALTER TABLE `yoshop_goods_image`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `yoshop_goods_sku`
--
ALTER TABLE `yoshop_goods_sku`
  ADD PRIMARY KEY (`goods_sku_id`),
  ADD UNIQUE KEY `sku_idx` (`goods_id`,`spec_sku_id`);

--
-- 表的索引 `yoshop_goods_spec_rel`
--
ALTER TABLE `yoshop_goods_spec_rel`
  ADD PRIMARY KEY (`id`);
...
--
-- 表的索引 `yoshop_order_address`
--
ALTER TABLE `yoshop_order_address`
  ADD PRIMARY KEY (`order_address_id`) USING BTREE;

--
-- 表的索引 `yoshop_order_extract`
--
ALTER TABLE `yoshop_order_extract`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- 表的索引 `yoshop_order_goods`
--
ALTER TABLE `yoshop_order_goods`
  ADD PRIMARY KEY (`order_goods_id`) USING BTREE;

--
-- 表的索引 `yoshop_order_refund`
--
ALTER TABLE `yoshop_order_refund`
  ADD PRIMARY KEY (`order_refund_id`);

--
-- 表的索引 `yoshop_order_refund_address`
--
ALTER TABLE `yoshop_order_refund_address`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `yoshop_order_refund_image`
--
ALTER TABLE `yoshop_order_refund_image`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `yoshop_printer`
--
ALTER TABLE `yoshop_printer`
  ADD PRIMARY KEY (`printer_id`);

--
-- 表的索引 `yoshop_recharge_order`
--
ALTER TABLE `yoshop_recharge_order`
  ADD PRIMARY KEY (`order_id`);

--
-- 表的索引 `yoshop_recharge_order_plan`
--
ALTER TABLE `yoshop_recharge_order_plan`
  ADD PRIMARY KEY (`order_plan_id`);

--
-- 表的索引 `yoshop_recharge_plan`
--
ALTER TABLE `yoshop_recharge_plan`
  ADD PRIMARY KEY (`plan_id`);

--
-- 表的索引 `yoshop_region`
--
ALTER TABLE `yoshop_region`
  ADD PRIMARY KEY (`id`),
  ADD KEY `name,level` (`name`);

--
-- 表的索引 `yoshop_return_address`
--
ALTER TABLE `yoshop_return_address`
...
--
-- 表的索引 `yoshop_sharing_active`
--
ALTER TABLE `yoshop_sharing_active`
  ADD PRIMARY KEY (`active_id`);

--
-- 表的索引 `yoshop_sharing_active_users`
--
ALTER TABLE `yoshop_sharing_active_users`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `yoshop_sharing_category`
--
ALTER TABLE `yoshop_sharing_category`
  ADD PRIMARY KEY (`category_id`);

--
-- 表的索引 `yoshop_sharing_comment`
--
ALTER TABLE `yoshop_sharing_comment`
  ADD PRIMARY KEY (`comment_id`);

--
-- 表的索引 `yoshop_sharing_comment_image`
--
ALTER TABLE `yoshop_sharing_comment_image`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `yoshop_sharing_goods`
--
...
--
-- 表的索引 `yoshop_sharing_goods_image`
--
ALTER TABLE `yoshop_sharing_goods_image`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `yoshop_sharing_goods_sku`
--
...
--
-- 表的索引 `yoshop_sharing_goods_spec_rel`
--
ALTER TABLE `yoshop_sharing_goods_spec_rel`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `yoshop_sharing_order`
--
...
--
-- 表的索引 `yoshop_sharing_order_address`
--
ALTER TABLE `yoshop_sharing_order_address`
  ADD PRIMARY KEY (`order_address_id`) USING BTREE;

--
-- 表的索引 `yoshop_sharing_order_extract`
--
ALTER TABLE `yoshop_sharing_order_extract`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- 表的索引 `yoshop_sharing_order_goods`
--
ALTER TABLE `yoshop_sharing_order_goods`
  ADD PRIMARY KEY (`order_goods_id`) USING BTREE;

--
-- 表的索引 `yoshop_sharing_order_refund`
--
ALTER TABLE `yoshop_sharing_order_refund`
  ADD PRIMARY KEY (`order_refund_id`);

--
-- 表的索引 `yoshop_sharing_order_refund_address`
--
ALTER TABLE `yoshop_sharing_order_refund_address`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `yoshop_sharing_order_refund_image`
--
ALTER TABLE `yoshop_sharing_order_refund_image`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `yoshop_sharing_setting`
--
ALTER TABLE `yoshop_sharing_setting`
  ADD UNIQUE KEY `unique_key` (`key`,`wxapp_id`);

--
-- 表的索引 `yoshop_spec`
--
ALTER TABLE `yoshop_spec`
  ADD PRIMARY KEY (`spec_id`);

--
-- 表的索引 `yoshop_spec_value`
--
ALTER TABLE `yoshop_spec_value`
  ADD PRIMARY KEY (`spec_value_id`);

--
-- 表的索引 `yoshop_store_access`
--
ALTER TABLE `yoshop_store_access`
  ADD PRIMARY KEY (`access_id`);

--
-- 表的索引 `yoshop_store_role`
--
ALTER TABLE `yoshop_store_role`
  ADD PRIMARY KEY (`role_id`);

--
-- 表的索引 `yoshop_store_role_access`
--
ALTER TABLE `yoshop_store_role_access`
  ADD PRIMARY KEY (`id`),
  ADD KEY `role_id` (`role_id`);

--
-- 表的索引 `yoshop_store_shop`
--
ALTER TABLE `yoshop_store_shop`
  ADD PRIMARY KEY (`shop_id`);

--
-- 表的索引 `yoshop_store_shop_clerk`
--
ALTER TABLE `yoshop_store_shop_clerk`
  ADD PRIMARY KEY (`clerk_id`);

--
-- 表的索引 `yoshop_store_shop_order`
--
ALTER TABLE `yoshop_store_shop_order`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `yoshop_store_user`
--
...
--
-- 表的索引 `yoshop_store_user_role`
--
ALTER TABLE `yoshop_store_user_role`
  ADD PRIMARY KEY (`id`),
  ADD KEY `admin_user_id` (`store_user_id`);

--
-- 表的索引 `yoshop_upload_file`
--
...
--
-- 表的索引 `yoshop_user_address`
--
ALTER TABLE `yoshop_user_address`
  ADD PRIMARY KEY (`address_id`);

--
-- 表的索引 `yoshop_user_balance_log`
--
ALTER TABLE `yoshop_user_balance_log`
  ADD PRIMARY KEY (`log_id`);

--
-- 表的索引 `yoshop_user_coupon`
--
ALTER TABLE `yoshop_user_coupon`
  ADD PRIMARY KEY (`user_coupon_id`);

--
-- 表的索引 `yoshop_user_grade`
--
ALTER TABLE `yoshop_user_grade`
  ADD PRIMARY KEY (`grade_id`),
  ADD KEY `wxapp_id` (`wxapp_id`);

--
-- 表的索引 `yoshop_user_grade_log`
--
ALTER TABLE `yoshop_user_grade_log`
  ADD PRIMARY KEY (`log_id`);

--
-- 表的索引 `yoshop_wow_order`
--
ALTER TABLE `yoshop_wow_order`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `yoshop_wow_setting`
--
ALTER TABLE `yoshop_wow_setting`
  ADD UNIQUE KEY `unique_key` (`key`,`wxapp_id`);

--
-- 表的索引 `yoshop_wow_shoping`
--
ALTER TABLE `yoshop_wow_shoping`
  ADD PRIMARY KEY (`id`);
...
--
-- 表的索引 `yoshop_wxapp_category`
--
ALTER TABLE `yoshop_wxapp_category`
  ADD PRIMARY KEY (`wxapp_id`);

--
-- 表的索引 `yoshop_wxapp_formid`
--
...
--
-- 表的索引 `yoshop_wxapp_help`
--
ALTER TABLE `yoshop_wxapp_help`
  ADD PRIMARY KEY (`help_id`);

--
-- 表的索引 `yoshop_wxapp_page`
--
...
--
-- 使用表AUTO_INCREMENT `yoshop_admin_user`
--
ALTER TABLE `yoshop_admin_user`
  MODIFY `admin_user_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_article`
--
ALTER TABLE `yoshop_article`
  MODIFY `article_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '文章id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_article_category`
--
ALTER TABLE `yoshop_article_category`
  MODIFY `category_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '商品分类id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_category`
--
ALTER TABLE `yoshop_category`
  MODIFY `category_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '商品分类id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_comment`
--
ALTER TABLE `yoshop_comment`
  MODIFY `comment_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '评价id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_comment_image`
--
ALTER TABLE `yoshop_comment_image`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_coupon`
--
ALTER TABLE `yoshop_coupon`
  MODIFY `coupon_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '优惠券id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_coupon_goods`
--
ALTER TABLE `yoshop_coupon_goods`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_dealer_apply`
--
ALTER TABLE `yoshop_dealer_apply`
  MODIFY `apply_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_dealer_capital`
--
ALTER TABLE `yoshop_dealer_capital`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_dealer_order`
--
ALTER TABLE `yoshop_dealer_order`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_dealer_referee`
--
ALTER TABLE `yoshop_dealer_referee`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_dealer_withdraw`
--
ALTER TABLE `yoshop_dealer_withdraw`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_delivery`
--
ALTER TABLE `yoshop_delivery`
  MODIFY `delivery_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '模板id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_delivery_rule`
--
ALTER TABLE `yoshop_delivery_rule`
  MODIFY `rule_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '规则id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_express`
--
ALTER TABLE `yoshop_express`
  MODIFY `express_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '物流公司id', AUTO_INCREMENT=10010;

--
-- 使用表AUTO_INCREMENT `yoshop_goods`
--
ALTER TABLE `yoshop_goods`
  MODIFY `goods_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '商品id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_goods_image`
--
ALTER TABLE `yoshop_goods_image`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10004;

--
-- 使用表AUTO_INCREMENT `yoshop_goods_sku`
--
ALTER TABLE `yoshop_goods_sku`
  MODIFY `goods_sku_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '商品规格id', AUTO_INCREMENT=10019;

--
-- 使用表AUTO_INCREMENT `yoshop_goods_spec_rel`
--
ALTER TABLE `yoshop_goods_spec_rel`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10016;

--
-- 使用表AUTO_INCREMENT `yoshop_order`
--
ALTER TABLE `yoshop_order`
  MODIFY `order_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '订单id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_order_address`
--
ALTER TABLE `yoshop_order_address`
  MODIFY `order_address_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '地址id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_order_extract`
--
ALTER TABLE `yoshop_order_extract`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_order_goods`
--
ALTER TABLE `yoshop_order_goods`
  MODIFY `order_goods_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_order_refund`
--
ALTER TABLE `yoshop_order_refund`
  MODIFY `order_refund_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '售后单id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_order_refund_address`
--
ALTER TABLE `yoshop_order_refund_address`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_order_refund_image`
--
ALTER TABLE `yoshop_order_refund_image`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_printer`
--
ALTER TABLE `yoshop_printer`
  MODIFY `printer_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '打印机id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_recharge_order`
--
ALTER TABLE `yoshop_recharge_order`
  MODIFY `order_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '订单id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_recharge_order_plan`
--
ALTER TABLE `yoshop_recharge_order_plan`
  MODIFY `order_plan_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_recharge_plan`
--
ALTER TABLE `yoshop_recharge_plan`
  MODIFY `plan_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_region`
--
ALTER TABLE `yoshop_region`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=50001;

--
-- 使用表AUTO_INCREMENT `yoshop_return_address`
--
ALTER TABLE `yoshop_return_address`
  MODIFY `address_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '退货地址id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_sharing_active`
--
ALTER TABLE `yoshop_sharing_active`
  MODIFY `active_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '拼单id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_sharing_active_users`
--
ALTER TABLE `yoshop_sharing_active_users`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_sharing_category`
--
ALTER TABLE `yoshop_sharing_category`
  MODIFY `category_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '商品分类id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_sharing_comment`
--
ALTER TABLE `yoshop_sharing_comment`
  MODIFY `comment_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '评价id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_sharing_comment_image`
--
ALTER TABLE `yoshop_sharing_comment_image`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_sharing_goods`
--
ALTER TABLE `yoshop_sharing_goods`
  MODIFY `goods_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '拼团商品id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_sharing_goods_image`
--
ALTER TABLE `yoshop_sharing_goods_image`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_sharing_goods_sku`
--
ALTER TABLE `yoshop_sharing_goods_sku`
  MODIFY `goods_sku_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '商品规格id', AUTO_INCREMENT=10007;

--
-- 使用表AUTO_INCREMENT `yoshop_sharing_goods_spec_rel`
--
ALTER TABLE `yoshop_sharing_goods_spec_rel`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10006;

--
-- 使用表AUTO_INCREMENT `yoshop_sharing_order`
--
ALTER TABLE `yoshop_sharing_order`
  MODIFY `order_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '订单id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_sharing_order_address`
--
ALTER TABLE `yoshop_sharing_order_address`
  MODIFY `order_address_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '地址id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_sharing_order_extract`
--
ALTER TABLE `yoshop_sharing_order_extract`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_sharing_order_goods`
--
ALTER TABLE `yoshop_sharing_order_goods`
  MODIFY `order_goods_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_sharing_order_refund`
--
ALTER TABLE `yoshop_sharing_order_refund`
  MODIFY `order_refund_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '售后单id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_sharing_order_refund_address`
--
ALTER TABLE `yoshop_sharing_order_refund_address`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_sharing_order_refund_image`
--
ALTER TABLE `yoshop_sharing_order_refund_image`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_spec`
--
ALTER TABLE `yoshop_spec`
  MODIFY `spec_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '规格组id', AUTO_INCREMENT=10003;

--
-- 使用表AUTO_INCREMENT `yoshop_spec_value`
--
ALTER TABLE `yoshop_spec_value`
  MODIFY `spec_value_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '规格值id', AUTO_INCREMENT=10006;

--
-- 使用表AUTO_INCREMENT `yoshop_store_access`
--
ALTER TABLE `yoshop_store_access`
  MODIFY `access_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10417;

--
-- 使用表AUTO_INCREMENT `yoshop_store_role`
--
ALTER TABLE `yoshop_store_role`
  MODIFY `role_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '角色id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_store_role_access`
--
ALTER TABLE `yoshop_store_role_access`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10093;

--
-- 使用表AUTO_INCREMENT `yoshop_store_shop`
--
ALTER TABLE `yoshop_store_shop`
  MODIFY `shop_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '门店id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_store_shop_clerk`
--
ALTER TABLE `yoshop_store_shop_clerk`
  MODIFY `clerk_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '店员id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_store_shop_order`
--
ALTER TABLE `yoshop_store_shop_order`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_store_user`
--
ALTER TABLE `yoshop_store_user`
  MODIFY `store_user_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10004;

--
-- 使用表AUTO_INCREMENT `yoshop_store_user_role`
--
ALTER TABLE `yoshop_store_user_role`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_upload_file`
--
ALTER TABLE `yoshop_upload_file`
  MODIFY `file_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '文件id', AUTO_INCREMENT=10003;

--
-- 使用表AUTO_INCREMENT `yoshop_upload_group`
--
ALTER TABLE `yoshop_upload_group`
  MODIFY `group_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '分类id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_user`
--
ALTER TABLE `yoshop_user`
  MODIFY `user_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '用户id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_user_address`
--
ALTER TABLE `yoshop_user_address`
  MODIFY `address_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10002;

--
-- 使用表AUTO_INCREMENT `yoshop_user_balance_log`
--
ALTER TABLE `yoshop_user_balance_log`
  MODIFY `log_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_user_coupon`
--
ALTER TABLE `yoshop_user_coupon`
  MODIFY `user_coupon_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_user_grade`
--
ALTER TABLE `yoshop_user_grade`
  MODIFY `grade_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '等级ID', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_user_grade_log`
--
ALTER TABLE `yoshop_user_grade_log`
  MODIFY `log_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_wow_order`
--
ALTER TABLE `yoshop_wow_order`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_wow_shoping`
--
ALTER TABLE `yoshop_wow_shoping`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10001;

--
-- 使用表AUTO_INCREMENT `yoshop_wxapp`
--
ALTER TABLE `yoshop_wxapp`
  MODIFY `wxapp_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '小程序id', AUTO_INCREMENT=10004;

--
-- 使用表AUTO_INCREMENT `yoshop_wxapp_formid`
--
ALTER TABLE `yoshop_wxapp_formid`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10030;

--
-- 使用表AUTO_INCREMENT `yoshop_wxapp_help`
--
ALTER TABLE `yoshop_wxapp_help`
  MODIFY `help_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id', AUTO_INCREMENT=10003;

--
-- 使用表AUTO_INCREMENT `yoshop_wxapp_page`
--
ALTER TABLE `yoshop_wxapp_page`
  MODIFY `page_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '页面id', AUTO_INCREMENT=10006;

--
-- 使用表AUTO_INCREMENT `yoshop_wxapp_prepay_id`
--
ALTER TABLE `yoshop_wxapp_prepay_id`
